...
function iris($id_tipo_correspondencia,
  ...
  $Insertpg = "INSERT INTO correspondencia (idcorreoprioridad, 
      idtipodocumento, 
      codigo, 
      referencia, 
      asunto, 
      ...
      descripcion, 
      creado, 
      fcreado) VALUES ('1', '".$id_tipo_documento."', 
	  '".$radicado_salida."', 
	  '".$referencia."', 
	  '".$asunto_correspondencia."', 
	  '".$idestado."', 
	  '1', '".$recibida."', '".$interno."', 
  NULL, '".$de."', NULL, '".$para."', '1', '1', '1', '".$fechaenvio."', '".$fechairis."', '".$textoiris."', '".$deint."', '".$fechairis."')";

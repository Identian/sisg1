  ...
  <div class="row">
   ...
   <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo existencia('candidato_votacion_fc'); ?></h3>
...
$query4="SELECT * from candidato_votacion_fc where estado_candidato_votacion_fc=1 ".$infop." ORDER BY id_candidato_votacion_fc  LIMIT 200 OFFSET ".$pagina." "; //LIMIT 500 OFFSET ".$pagina."
...
<tbody>
				...
				<?php
echo '<td>';
echo $row['id_candidato_votacion_fc'];
echo '</td>';
echo '<td>';
echo $row['nombre_candidato_votacion_fc'];
echo '</td>';
echo '<td>';
...
echo  '<a href="https://sisg.supernotariado.gov.co/inscripcion_votacion_fondo_cuenta&'.$idf1.'.jsp"  target="_blank">Ver</a> ';

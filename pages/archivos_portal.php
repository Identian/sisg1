...
if (1==$_SESSION['rol'] or 0<$nump77 or 0<$nump73 or 0<$nump78 or 0<$nump76) {
...
<div class="box-header with-border">
  ...
  <div class="col-md-4">
<?php  if (1==$_SESSION['rol'] or 0<$nump77 or 0<$nump73 or 0<$nump78  or 0<$nump76) { ?>
...
$query4="SELECT * from archivo_portal, contenido_publicacion where estado_archivo_portal=1 ".$infop." and archivo_portal.id_contenido=contenido_publicacion.id_contenido_publicacion ORDER BY id_archivo_portal desc";
...
if (isset($row['fecha_archivo_portal'])) {
echo '<td>'.$row['fecha_archivo_portal'].'</td>';
} else {
echo '<td>2020/2021</td>';
}

echo '<td>'.$row['nombre_contenido_publicacion'].'</td>';
	echo '<td><a href="https://servicios.supernotariado.gov.co/files/portal/'.$row['nombre_archivo_portal'].'" target="_blank">https://servicios.supernotariado.gov.co/files/portal/'.$row['nombre_archivo_portal'].'</a></td>';
	echo '<td><a href="https://servicios.supernotariado.gov.co/files/portal/'.$row['nombre_archivo_portal'].'" target="_blank"><img src="images/pdf.png"></a></td>';

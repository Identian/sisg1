...
if (isset($_GET['e']) && "" != $_GET['e']) {
	$radi='SNR2021EE043563';  // EE PARA SALIDAS
	$ide=$_GET['e'];
...
//$correomov2='giovanni.ortegon@supernotariado.gov.co';
...
<a href=""  class="btn ventana1" STYLE="background:#F39C3F;color:#fff;" data-toggle="modal" data-target="#popupdetalle" >
Modificar
</a> 
<a href="movimiento_pqrs&'.$id.'&'.$rowk['id_movimiento_pqrs'].'.jsp"  class="btn btn-sucess ventana1" STYLE="background:#4BA75B;color:#fff;">
Aprobar
</a>
</div>';
}

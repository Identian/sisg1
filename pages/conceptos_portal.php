...
if ((isset($_POST["table"])) && ($_POST["table"] == "instruccion_admin") && (1==$_SESSION['rol'] or 0<$nump83)) {
...
$directoryftp="files/content/conceptos/";

if (isset($_FILES['file']['name']) && ""!=$_FILES['file']['name']) {

$ruta_archivo = 'concepto-'.$_POST["numero_archivo"].'-'.date("YmdGis");
...
GetSQLValueString($_POST["nombre_archivo"], "text"), 
GetSQLValueString('conceptos', "text"),
GetSQLValueString('content/conceptos', "text"),
  ...
  <div class="row">
   ...
   <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo existenciaunica('archivo', 'id_normatividad', 3); ?></h3>
...
$query4="SELECT * from archivo where estado_archivo=1 ".$infop." and id_normatividad=3 ORDER BY fecha_publicacion desc  "; //LIMIT 500 OFFSET ".$pagina."

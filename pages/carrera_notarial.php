...
if ((isset($_POST["table"])) && ($_POST["table"] == "carrera_notarial")) {
...
$directoryftp="files/portal/carrera_notarial/";


if (isset($_FILES['file']['name']) && ""!=$_FILES['file']['name']) {

$ruta_archivo = 'carrera-'.$_SESSION['snr'].'-'.date("YmdGis");
...
$insertSQL = sprintf("INSERT INTO carrera_notarial (nombre_carrera_notarial, 
id_notaria,  fecha_publicacion, url, estado_carrera_notarial) 
VALUES (%s, %s, now(), %s, %s)", 
GetSQLValueString($_POST["nombre_carrera_notarial"], "text"), 
...
?>
  ...
  <div class="row">
   ...
   <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo existencia('carrera_notarial'); ?></h3>
 ...
 <h3>
 <?php echo existencialimitada('carrera_notarial', 'fecha_publicacion', $realdate) ?></h3>
...
<div class="box-header with-border">
  ...
  <div class="col-md-4">
    ...
    <h3  class="box-title">
	<?php  if (1==$_SESSION['rol'] or 0<$nump122) { ?>
...
<option value="nombre_tipo_carrera_notarial">Tipo de estado contable</option>
		  </select>
</div>
...
$query4="SELECT * from carrera_notarial where estado_carrera_notarial=1 ".$infop." ORDER BY fecha_publicacion desc ";
...
?>  
				...
				<tr>
				<?php
$id_res=$row['id_carrera_notarial'];
//echo '<td>'.$row['nombre_departamento'].'</td>';
//echo '<td>'.$row['nombre_notaria'].'</td>';
echo '<td>'.$row['fecha_publicacion'].'</td>';
echo '<td>'.$row['nombre_carrera_notarial'].'</td>';

echo '<td>';
echo ' <a href="files/portal/carrera_notarial/'.$row['url'].'" target="_blank"><img src="images/pdf.png"></a>';

	if (1==$_SESSION['rol'] or 0<$nump122) { 
	echo ' <a style="color:#ff0000;cursor: pointer" title="Borrar" name="carrera_notarial" id="'.$id_res.'" class="borrar_f"><span class="glyphicon glyphicon-trash"></span></a>';
	} else {}
echo '</td>';
?>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 style="font-weight: bold; text-align: center;" class="modal-title" id="myModalLabel">Nuevo acuerdo</h4>
      </div>
      <div class="modal-body">
        
<form action="" method="POST" name="for54354r6trtret5464563m1" enctype="multipart/form-data" >
...
<textarea class="form-control" name="nombre_carrera_notarial"></textarea>
</div>

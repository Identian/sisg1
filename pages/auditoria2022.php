...
if (isset($_GET['i'])) {
$number=$_GET['i'];
$query = "SELECT * FROM auditoria2022 where url LIKE '%radicacion_curaduria&".$number.".jsp%' order by id_auditoria desc limit 1000";
} else {
...
$query = "SELECT * FROM auditoria2022 where ".$infobusqueda." order by id_auditoria desc limit 1000";

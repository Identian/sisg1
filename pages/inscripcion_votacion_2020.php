...
$queryk = "SELECT count(id_funcionario) as totp FROM notario_propiedad where id_funcionario=".$_GET["i"].""; 
...
$queryk = "SELECT count(id_funcionario) as totp FROM notario_propiedad where id_funcionario=".$_SESSION['snr'].""; 
$selectk = mysql_query($queryk, $conexion);
$rowpk = mysql_fetch_assoc($selectk);
$valp=$rowpk['totp'];
mysql_free_result($selectk);
...
$select = mysql_query("select count(id_candidato_votacion) as totale from candidato_votacion where (id_funcionario1=".$idf1." or id_funcionario2=".$idf1." or  id_funcionario1=".$idf2." or id_funcionario2=".$idf2." ) and estado_candidato_votacion=1", $conexion);
...
$insertSQL = sprintf("INSERT INTO candidato_votacion (nombre_candidato_votacion, 
id_funcionario1, id_funcionario2, id_notaria1, id_notaria2, url, estado_candidato_votacion) VALUES (now(), %s, %s, %s, %s, %s, %s)", 
...
$cuerpo .= 'La superintendencia de notariado y registro informa que se ha registrado correctamente una inscripcion como candidato a las elecciones de representantes de notarios ante el CSCN 2020.';
$cuerpo .= "<br><br>"; 
...
$cuerpo2 .= 'La superintendencia de notariado y registro informa que se ha registrado correctamente su inscripcion como candidato a las elecciones de representantes de notarios ante el CSCN 2020.';
$cuerpo2 .= "<br><br>"; 
$cuerpo .= "Notaria: ".$nombre_notaria; 
$cuerpo .= "<br><br>"; 
$cuerpo2 .= 'Incripción: <a href="https://sisg.supernotariado.gov.co/inscripcion_votacion_2020.jsp">Ver inscripción</a>'; 
$cuerpo2 .= "<br><br>";  
...
<h3 class="box-title">INSCRIPCIÓN A VOTACIÓN</h3>
...
$selecti = mysql_query("select * from candidato_votacion where (id_funcionario1=".$id." or id_funcionario2=".$id." ) and estado_candidato_votacion=1 limit 1", $conexion);
...
$idv=$rowi['id_candidato_votacion'];
...
<?php 
echo 'Fecha de inscripción: '.$rowi['nombre_candidato_votacion'].'<br>';
...
$query = "SELECT * FROM funcionario, notario_propiedad, notaria
WHERE funcionario.id_funcionario=notario_propiedad.id_funcionario 
and notario_propiedad.id_notaria=notaria.id_notaria 
...
<label  class="control-label"><span style="color:#ff0000;">*</span> SOLICITUD: <a href="documentos/Formato_inscripcion_votacion.docx">Descargar modelo</a></label> 
...
$query = "SELECT nombre_funcionario, funcionario.id_funcionario FROM notario_propiedad, funcionario where notario_propiedad.id_funcionario=funcionario.id_funcionario and estado_notario_propiedad=1 and funcionario.id_funcionario!=".$id.""; 

        ...
        <table class="table table-striped table-bordered table-hover" id="tab_causantes">
          ...
          <tr style = "color: black">
			...
			$sw5 = 0;
			 ...
			 <td><?php echo utf8_encode($nombre_entidad); ?></td>
			 ...
			 <td><?php echo $fecha_causacion; ?></td>

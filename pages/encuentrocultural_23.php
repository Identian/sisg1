...
if (0<$rowtt['tfuncionario']) {
	...
	$query = sprintf("SELECT count(id_encuentrocultural23) as tencuentrocultural23 FROM encuentrocultural23 where estado_encuentrocultural23=1 and id_funcionario=".$_SESSION['snr'].""); 
$select = mysql_query($query, $conexion);
$rowt = mysql_fetch_assoc($select);
if (0<$rowt['tencuentrocultural23']) {
...
$ruta_archivo = 'encuentrocultural23-'.$_SESSION['snr'].''.date("YmdGis");
...
$insertSQL = sprintf("INSERT INTO encuentrocultural23 (
nombre_encuentrocultural23, id_funcionario, categoria,  modalidad, grupo, 
nombre_artistico, nombre_menor, identidad_menor, genero_menor,  
url, estado_encuentrocultural23) 
...
$subject = 'CONFIRMACIÓN DE INSCRIPCIÓN A ENCUENTRO FOLCLORICO Y CULTURAL 2023';
$cuerpo2 = ''; 
...
$cuerpo2 .= 'Vicky de la Superintendencia de Notariado y Registro informa que se ha registrado correctamente la inscripción al encuentro folclorico y cultural SNR 2023.<br><br>';
  ...
  <div class="row">
   ...
   <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo existencia('encuentrocultural23'); ?></h3>
...
<div class="box-header with-border">
  ...
  <p>
<b>  Inscripción a Encuentro Cultural 2023:</b>
...
$query4="SELECT * from encuentrocultural23, funcionario where encuentrocultural23.id_funcionario=funcionario.id_funcionario and estado_encuentrocultural23=1 ".$infop." ORDER BY id_encuentrocultural23 desc  "; //LIMIT 500 OFFSET ".$pagina."
} else {
$query4="SELECT * from encuentrocultural23, funcionario where encuentrocultural23.id_funcionario=funcionario.id_funcionario and estado_encuentrocultural23=1 and funcionario.id_funcionario=".$_SESSION['snr']." ORDER BY id_encuentrocultural23 desc  "; //LIMIT 500 OFFSET ".$pagina."
}
...
<tr>
				<?php
$id_res=$row['id_encuentrocultural23'];
echo '<td>'.$row['nombre_encuentrocultural23'].'</td>';
...
echo '<td>';
//echo ' <a href="" class="buscarencuentrocultural23" id="'.$id_res.'" title="Actualizar" data-toggle="modal" data-target="#popupactualizarencuentrocultural23"> <i class="fa fa-edit"></i></a> ';
echo ' <a href="filesnr/encuentrocultural/'.$row['url'].'" target="_blank" > <i class="fa fa-file"></i></a> ';


//or 0<$nump111
	if (1==$_SESSION['rol'] or 0<$nump111) { 
echo ' <a style="color:#ff0000;cursor: pointer" title="Borrar" name="encuentrocultural23" id="'.$id_res.'" class="borrar_f"><span class="glyphicon glyphicon-trash"></span></a>';
...
<div class="modal fade" id="popupactualizarencuentrocultural23" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
...
<div id="ver_actualizarencuentrocultural23" class="modal-body"> 

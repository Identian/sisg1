...
$nump156=privilegios(156,$_SESSION['snr']);


if (1==$_SESSION['rol'] or 0<$nump156) {
...
//  Jefes inmediato de Area 
  if (($id_grupo_area < 26 or ($id_grupo_area > 30 and $id_grupo_area !=  47)) and $id_cargo <= 2 and $id_funcionario > 0){ // Jefes inmediato de Area 
    $privi = " AND a.id_aprobacion_permiso IN(0,1,2) AND b.id_grupo_area = '$id_grupo_area'  ";
	$sw5 = 10;
	} else {
    $id= 0;
}
...
if (isset($_GET["e"]) && ""!=$_GET["e"]) {
    $id_funcpermiso=intval($_GET["e"]);

   $query84 = "UPDATE funcpermiso SET estado_funcpermiso=0  WHERE id_funcpermiso = ".$id_funcpermiso." limit 1";  
   $query86 = "UPDATE detalle_permiso SET estado_detalle_permiso =0  WHERE id_permiso = ".$id_funcpermiso." limit 50";  
   $query88 = "UPDATE docto_permiso SET estado_docto_permiso =0  WHERE id_permiso = ".$id_funcpermiso." limit 50";  
    ...
    <nav class="navbar navbar-default" style="background:#fff;">
      <div class="container-fluid">
        <div class="navbar-header">
		  ...
		  <p style="font-size: 20px"><b>MÓDULO DE PERMISOS</b></p>
        </div>
      </div>
    </nav>
  </div>
        ...
        <table class="table table-striped table-bordered table-hover" id="tab_sucesiones">
           <thead>
            ...
            <?php
              ...
              $query875 = sprintf("SELECT a.id_funcpermiso, a.id_funcionario,
			                                b.nombre_funcionario, c.nombre_tipo_permiso,
                                            a.id_funcionario_reempla, 
											e.nombre_funcionario AS nombre_funcionario_reem,
											a.id_aprobacion_permiso, 
											a.id_funcionario_jefe, a.fecha_inicio, a.fecha_final,
                                            a.hora_inicio, a.hora_final,											
											a.id_tipo_permiso,
											d.nombre_aprobacion_permiso, a.motivo_permiso,
											b.id_tipo_oficina, b.id_grupo_area, b.id_oficina_registro
                             			    FROM funcpermiso a
			                                LEFT JOIN funcionario b
											ON a.id_funcionario = b.id_funcionario
											LEFT JOIN tipo_permiso c
											ON a.id_tipo_permiso = c.id_tipo_permiso
											LEFT JOIN aprobacion_permiso d
											ON a.id_aprobacion_permiso = d.id_aprobacion_permiso
			                                LEFT JOIN funcionario e
											ON a.id_funcionario_reempla = e.id_funcionario
                          WHERE a.estado_funcpermiso = 1 ".$privi." order by a.fecha_inicio desc, a.id_aprobacion_permiso ");
...
//			  echo " select: ".$query875;
          ...
          <tr>
		     <?php 
			 $id_funcpermiso = $row_dian['id_funcpermiso'];
		     $id_funcionario9 = $row_dian['id_funcionario'];
             $id_funcionario_reempla = $row_dian['id_funcionario_reempla'];
			 $id_tipo_permiso  =  $row_dian['id_tipo_permiso'];
			 $nom_tipoau   =  $row_dian['nombre_tipo_permiso'];
			 $id_aprobacion_permiso = $row_dian['id_aprobacion_permiso'];
			...
			$sw5 = 0;
			 ...
			 <td  style = "display: none"><?php echo $id_tipo_permiso; ?></td>
             <td><?php echo $nombre_tipo_permiso; ?></td>
			 ...
			 <td style = "display: none"><?php echo $row_dian['id_tipo_permiso']; ?></td>
			 <td><?php echo $row_dian['id_aprobacion_permiso']; ?></td>
             <td><?php echo $row_dian['nombre_aprobacion_permiso']; ?></td>
			 <td><?php echo $row_dian['motivo_permiso']; ?></td>
...
<!--  			    <a href="ausentismo_eva_dt&<?php echo $nodo_dev; ?>.jsp"><span class="btn btn-info btn-xs" title="Consultar"><span  class="glyphicon glyphicon-hand-up"></span></a> &nbsp; -->
                <a href="consulta_permiso_funcionario&<?php echo $id_funcpermiso; ?>.jsp"><span class="btn btn-info btn-xs" title="Consultar"><span  class="glyphicon glyphicon-hand-up"></span></a> &nbsp;
             </td> 
             <?php if (($id_cargo <= 2) or (1==$_SESSION['rol'])) {  // JEFE INMEDIATO $id_cargo <= 2 id_grupo_area != 47 (DTR)  != 26 RRHH ?>			 
			 <td>
			 ...
			 <?php } ?>
		     <td> 
			    <a href="pdf/solicitud_permiso&<?php echo $id_funcpermiso; ?>.pdf" title="Formato Solicitud"><img src="images/pdf.png"></a>
          </td>

             <?php if($id_aprobacion_permiso  < 1) { ?>
             <td>
                <a href="permiso_funcionario&<?php echo $id_funcionario; ?>&<?php echo $id_funcpermiso; ?>.jsp" class="confirmationdel" style="color:#ff0000;cursor: pointer" title="Borrar"  ><span class="glyphicon glyphicon-trash"></span></a>
             </td>
			<?php } ?>
          </tr>
...
<h4 class="modal-title" id="myModalLabel"><b>APROBACIÓN PERMISO JEFE</b><span class="licenciac" style="font-weight: bold;"></span></h4>
</div> 
<div id="nuevaAventura" class="modal-body"> 

<form action="" method="POST" name="form4377224"  enctype="multipart/form-data">

    <input type="hidden" class="form-control" name="id_funcpermiso" id="id_funcpermiso" readonly="readonly" value="">
    <input type="hidden" class="form-control" name="id_tipo_permiso2" id="id_tipo_permiso2" readonly="readonly" value=""> 
    ...
    <div class="form-group text-left"> 
      ...
      <input type="text" class="form-control" name="nombre_tipo_permiso2" id="nombre_tipo_permiso2" readonly="readonly" value="">
    </div>
...
<!--      <input type="text" class="form-control" name="funcionario_jefe" id="funcionario_jefe" readonly="readonly" value=""> -->
    ...
    <div class="form-group text-left"> 
      ...
      <select class="form-control" name="id_aprobacion_permiso2" id="id_aprobacion_permiso2" required>
            <option value="" selected></option>
            <?php  echo lista2('aprobacion_permiso', '0,1,2'); ?>
      </select>
    </div>	

    <div class="form-group text-left"> 
        <label  class="control-label">MOTIVO DEL PERMISO:</label>   
        <textarea rows="5" cols="20" class="form-control" id="motivo_permiso2"  name="motivo_permiso2" value="" readonly="readonly"  ></textarea>
	</div>
     ...
     <div class="modal-dialog">
          <div class="modal-content">
              <div class="modal-header"> 
                   ...
                   <h4 class="modal-title" id="myModalLabel"><b>SOLICITUD DE PERMISO</b></h4>
				   <h5 class="modal-title mensajeaclaracion" id="myModalLabel"><b>En este Módulo, solo se registran permisos menores a 4 días</b></h5>
              </div> 
              <div id="nuevaAventura" class="modal-body"> 
                ...
                <script>
				 ...
				 FROM funcpermiso aus, detalle_permiso deaus
				 where deaus.num_horas = 0 
				 and aus.id_funcpermiso = deaus.id_funcpermiso 
				 and aus.id_funcionario=".$id_funcionario.
				 " and deaus.id_aprobacion_permiso = 1 
                ...
                ?>
                   ...
                   <input type="hidden" class="form-control" name="id_oficina_registro" id="id_oficina_registro" readonly="readonly" value="<?php echo $id_oficina_registro; ?>"> 
				         ...
				         <div class="form-group text-left"> 
                              ...
                              <select class="form-control" name="id_tipo_permiso" id="id_tipo_permiso" onChange = "totalaus();">
                              <option value="" selected></option>
                         ...
                         <div class="form-group text-left"> 
                              <label  class="control-label"><span style="color:#ff0000;">*</span> Total Permisos:</label> 
                         ...
                         <div class="form-group text-left"> 
                              <label  class="control-label"><span style="color:#ff0000;">*</span> Motivo del Permiso:</label>   
...
//		alert("fecha inicio: " + fecha_inicio);
		...
		var totdias = Number(Math.round(Number((diasdif / 1000000) / 31526),0));
//		alert ('diasdif1: ' +  totdias);
//		alert("difer: " + diasdif);
        if(diasdif <= 0) {
			hdesde.style.display='block';
		    ...
		    if (totdias > 2) {
//			   alert ('diasdif2: ' +  diasdif);
			   alert("En este Módulo, solo se registran permisos menores a 4 días...!. Si es mayor se debe reportar a Secretaria Gral");
			   document.getElementById('fecha_final').value = fecha_inicio;
...
if (isset($_POST['archausentismo'])) {
   ...
   $result55->free();	
	...
	if ($regdo > 0){ 
	   echo $repetido; 
       echo '<meta http-equiv="refresh" content="0;URL= ./permiso_funcionario.jsp" />';
    } else{

    $tmp_fi = $fecha_inicio;
	$num_horas2 = $num_horas;
	
	$insertSQL = sprintf("INSERT INTO funcpermiso (
      id_funcionario, id_tipo_permiso, fecha_inicio,
      hora_inicio, fecha_final, hora_final, 
      id_funcionario_jefe, id_funcionario_reempla,
      motivo_permiso, motivo_rechazo, fecha_registro) 
	  VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, now())", 
      GetSQLValueString($id_funcionario, "int"), 
	  GetSQLValueString($id_tipo_permiso, "int"),
	  ...
	  global $mysqli;
	   ...
	   $query29 = "SELECT id_funcpermiso 
        ...
        while ($obj29 = $result29->fetch_array()) {
                $id_funcpermiso = $obj29['id_funcpermiso'];
        }
       $result29->free();	
	...
	if ($estado == 100) {   
	$insertSQL5 = sprintf("INSERT INTO detalle_permiso (
      id_funcpermiso, id_funcionario, id_tipo_permiso, 
	  fecha_secuencia,
   ...
   if (""!=$_FILES['file']['tmp_name']) { // 2
	   ...
	   $query39 = "SELECT id_funcpermiso 
        ...
        while ($obj39 = $result39->fetch_array()) {
				$id_funcpermiso2 = $obj39['id_funcpermiso'];
        }
       $result39->free();	
...
//          $hash=md5($files);
            $id_tipo_docto_permiso = 0; // 0 = Evidencia
            $descrip_docto_permiso = "EVIDENCIA DEL PERMISO";
            ...
            GetSQLValueString($id_funcpermiso2, "int"), 
            GetSQLValueString($id_tipo_docto_permiso, "int"),
            GetSQLValueString($nombre_img, "text"),
			GetSQLValueString( $descrip_docto_permiso, "text"));
	        $Result = mysql_query($insertSQL, $conexion) or die(mysql_error());
 ...
 //           echo $insertado;
  ...
  // envío del correo al jefe inmediato
   ...
   $result38->free();	
     ...
     $query39 = "SELECT nombre_tipo_permiso
			  FROM tipo_permiso 
			  WHERE id_tipo_permiso = '$id_tipo_permiso' 
			   AND estado_tipo_permiso =1 ";
    $result39 = $mysqli->query($query39);
    while ($obj39 = $result39->fetch_array()) {
        $nombre_tipo_ausentismo = $obj39['nombre_tipo_permiso'];
    }
   $result39->free();	
...
if (isset($_POST['actajefeusen'])) {
	...
	$id_funcionario2 = $_POST['id_funcionario2'];
	$id_funcionario_jefe2 = $_POST['id_funcionario_jefe2'];
	$nombre_funcionario2 = $_POST['nombre_funcionario2'];
	$id_tipo_permiso = $_POST['id_tipo_permiso2'];
    $id_aprobacion_permiso = $_POST['id_aprobacion_permiso2'];
    ...
    $updateSQL37 = sprintf("UPDATE funcpermiso
			...
			hora_final = %s,
			fecha_aprueba = now(),
            id_aprobacion_permiso = %s			
			WHERE id_funcpermiso = %s",                  
	GetSQLValueString($fecha_inicio, "date"),
	GetSQLValueString($hora_inicio, "text"),
	GetSQLValueString($fecha_final, "date"),
	GetSQLValueString($hora_final, "text"),
	GetSQLValueString($id_aprobacion_permiso, "text"),
	GetSQLValueString($id_funcpermiso, "int"));
    $Result137 = mysql_query($updateSQL37, $conexion) or die(mysql_error());

	$query64 = "UPDATE detalle_permiso 
	SET estado_detalle_permiso = 0  
...
// if($id_aprobacion_permiso == 19 and $id_tipo_oficina2 == 29) {   // Aprobación del Jefe inmediato
       ...
       $query17 = "SELECT id_funcionario, nombre_funcionario,
	           correo_funcionario
	           FROM funcionario
			   WHERE id_funcionario = '$id_funcionario2'
			   AND estado_funcionario =1 ";
        $result17 = $mysqli->query($query17);
        while ($obj17 = $result17->fetch_array()) {
//           $id_funcionario_jefe_dtr  = $obj17['id_funcionario'];
		   $nombre_funcionario2 = $obj17['nombre_funcionario'];
		   $correo_funcionario2  = $obj17['correo_funcionario'];
        }
        $result17->free();	
    ...
    $result39 = $mysqli->query($query39);
    while ($obj39 = $result39->fetch_array()) {
        $nombre_tipo_permiso = $obj39['nombre_tipo_permiso'];
    }
   $result39->free();
     ...
     $query49 = "SELECT nombre_aprobacion_permiso
			  FROM aprobacion_permiso 
			  WHERE id_aprobacion_permiso = '$id_aprobacion_permiso' 
			   AND estado_aprobacion_permiso = 1 ";
    $result49 = $mysqli->query($query49);
    while ($obj49 = $result49->fetch_array()) {
        $nombre_aprobacion_permiso = $obj49['nombre_aprobacion_permiso'];
    }
   $result49->free();
...
// $correo_funcionario2 = "oscar.ortegon@supernotariado.gov.co";

ini_set( 'display_errors', 1 );
error_reporting( E_ALL );
      $emailune = $correo_funcionario2;
      $subject = 'Autorización de Aprobación de Permiso';
      $cuerpo = '';
      $cuerpo .= "<div style='background:#f2f2f2;'><br><div style='margin: 0 auto;background:#fff;max-width:650px;width:100%;padding: 10px 10px 10px 10px;'><img src='https://servicios.supernotariado.gov.co/vista/img/snr-chat.jpg'>";
      $cuerpo .= "SISG - le informa que el jefe inmediato ha emitido el estado de ".$nombre_aprobacion_permiso." a su solicitud";
      $cuerpo .= "<br><br>";
	  $cuerpo .= '<br>Solicitante: '.$nombre_funcionario2.'<br>';
      $cuerpo .= '<br>Tipo de Permiso: '.$nombre_tipo_permiso.' desde: '.$fecha_inicio.' Hasta: '.$fecha_final.'<br>';
	  if ($fecha_inicio == $fecha_final){
	     $cuerpo .= '<br>Total Horas: '.$num_horas.'<br>';
	  } else {
	     $cuerpo .= '<br>Total Dias: '.$num_dias.'<br>';

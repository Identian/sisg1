...
$actualizar5 = mysql_query("SELECT nombre_municipio, id_municipio FROM municipio WHERE id_departamento='$parametro' order by nombre_municipio", $conexion) or die(mysql_error());

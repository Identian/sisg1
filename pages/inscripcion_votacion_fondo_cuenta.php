...
if (2==2){
	echo 'Se supero el plazo de tiempo de la inscrpción.';
} else {
if ((1==$_SESSION['rol']) and isset($_GET["i"])) {

$queryk = "SELECT funcionario.id_funcionario, notaria.id_notaria,  cedula_funcionario, 
...
AND notaria.id_categoria_notaria=3 and fecha_fin is null and estado_posesion_notaria=1 and posesion_notaria.id_funcionario=".$_GET["i"].""; 
...
WHERE funcionario.id_funcionario=posesion_notaria.id_funcionario 
and posesion_notaria.id_notaria=notaria.id_notaria 
AND notaria.id_categoria_notaria=3 and fecha_fin is null and estado_posesion_notaria=1 and posesion_notaria.id_funcionario=".$_SESSION['snr']." "; 
$selectk = mysql_query($queryk, $conexion);
$row = mysql_fetch_assoc($selectk);
$valp=$row['id_funcionario'];
mysql_free_result($selectk);
...
$select = mysql_query("select count(id_candidato_votacion_fc) as totale from candidato_votacion_fc where (id_funcionario1=".$idf1." or id_funcionario2=".$idf1." or  id_funcionario1=".$idf2." or id_funcionario2=".$idf2." ) and estado_candidato_votacion_fc=1", $conexion);
...
$insertSQL = sprintf("INSERT INTO candidato_votacion_fc (nombre_candidato_votacion_fc, 
id_funcionario1, id_funcionario2, id_notaria1, id_notaria2, url, estado_candidato_votacion_fc) 
...
$subject = 'Inscripción a Votación de Notariado';
$cuerpo = ''; 
...
$cuerpo .= 'La Superintendencia de Notariado y Registro informa que se ha registrado correctamente una inscripción como candidato a las elecciones de representantes de notarios de tercera categoria ante el FCEN 2020.';
$cuerpo .= "<br><br>"; 
$cuerpo .= "Notaria: ".$nombre_notaria; 
$cuerpo .= "<br><br>"; 
$cuerpo .= 'Incripción: <a href="https://sisg.supernotariado.gov.co/inscripcion_votacion_2020&'.$idf1.'.jsp">Ver inscripción</a>'; 
$cuerpo .= "<br><br>";  
...
$cuerpo2 .= 'La Superintendencia de Notariado y Registro informa que se ha registrado correctamente una inscripción como candidato a las elecciones de representantes de notarios de tercera categoria ante el FCEN 2020.';
$cuerpo2 .= "<br><br>"; 
$cuerpo .= "Notaria: ".$nombre_notaria; 
$cuerpo .= "<br><br>"; 
$cuerpo2 .= 'Incripción: <a href="https://sisg.supernotariado.gov.co/inscripcion_votacion_fondo_cuenta.jsp">Ver inscripción</a>'; 
$cuerpo2 .= "<br><br>";  
 ...
 <div id="navbar" class="navbar-collapse collapse">
     ...
     <?php echo $rownotaria;?>
            ...
            <li><a href="notaria_datos_facturacion<?php if (1==$_SESSION['rol']) { echo '&'.$id; } else {} ?>.jsp">Datos Facturación</a></li>
		     ...
		     <li><a href="inscripcion_votacion_2020<?php if (1==$_SESSION['rol']) { echo '&'.$id; } else {} ?>.jsp" title="Inscripción a la Votación CSCN 2020">Ins. Vot. 2020</a></li>
...
<h3 class="box-title">INSCRIPCIÓN A VOTACIÓN FONDO CUENTA 2020</h3>
...
$selecti = mysql_query("select * from candidato_votacion_fc where (id_funcionario1=".$id." or id_funcionario2=".$id." ) and estado_candidato_votacion_fc=1 limit 1", $conexion);
...
$idv=$rowi['id_candidato_votacion_fc'];
...
<?php 
echo 'Fecha de inscripción: '.$rowi['nombre_candidato_votacion_fc'].'<br>';
...
<label  class="control-label"><span style="color:#ff0000;">*</span> SOLICITUD: <a href="documentos/FormatoFC.docx">Descargar modelo</a></label> 
...
$query = "SELECT nombre_funcionario, funcionario.id_funcionario FROM funcionario, posesion_notaria, notaria
WHERE funcionario.id_funcionario=posesion_notaria.id_funcionario 
and posesion_notaria.id_notaria=notaria.id_notaria 
AND notaria.id_categoria_notaria=3 and fecha_fin is null and estado_posesion_notaria=1 and funcionario.id_funcionario!=".$id.""; 

...
if ((isset($_POST["nombre_dia_mujer_23"])) && (""!=$_POST["nombre_dia_mujer_23"]) && 1==2) {
	
$tipo=$_POST["nombre_dia_mujer_23"];

if ('Virtual'==$tipo) {
$query = sprintf("SELECT count(id_dia_mujer_23) as tt FROM dia_mujer_23 where estado_dia_mujer_23=1 and nombre_dia_mujer_23='$tipo'"); 
...
$query = sprintf("SELECT count(id_dia_mujer_23) as ccc FROM dia_mujer_23 where id_funcionario=".$_SESSION['snr']." and estado_dia_mujer_23=1"); 
$select = mysql_query($query, $conexion);
$rowt = mysql_fetch_assoc($select);
if (0<$rowt['ccc']) {
	...
	$insertSQL = sprintf("INSERT INTO dia_mujer_23 (
      id_funcionario, fecha_registro, nombre_dia_mujer_23, transporte, estado_dia_mujer_23) 
	  VALUES (%s, now(), %s, %s, %s)", 
...
?>
  ...
  <div class="row">
   ...
   <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo existencia('dia_mujer_23'); ?></h3>
 ...
 <h3><?php 
 $query4 = sprintf("SELECT count(id_dia_mujer_23) as contador FROM dia_mujer_23 where 
 nombre_dia_mujer_23='Virtual' and estado_dia_mujer_23=1"); 
 ...
 ?></h3>
     ...
     <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            <div class="inner">
              <h3><?php  $query4 = sprintf("SELECT count(id_dia_mujer_23) as contador FROM dia_mujer_23 where 
 nombre_dia_mujer_23='Presencial' and estado_dia_mujer_23=1"); 
$result4 = $mysqli->query($query4);
$row4 = $result4->fetch_array(MYSQLI_ASSOC);
echo $row4['contador'];
$result4->free();
...
<div class="box-header with-border">
  ...
  <div class="col-md-12">
	...
	<?php
 if(1==2)  //$fecha_actual > $fecha_limite)
	{
...
$query4="SELECT * from dia_mujer_23, funcionario, grupo_area where funcionario.id_grupo_area=grupo_area.id_grupo_area and dia_mujer_23.id_funcionario=funcionario.id_funcionario and estado_dia_mujer_23=1  ORDER BY id_dia_mujer_23 desc  "; //LIMIT 500 OFFSET ".$pagina."
} else {
$query4="SELECT * from dia_mujer_23, funcionario, grupo_area where funcionario.id_grupo_area=grupo_area.id_grupo_area and dia_mujer_23.id_funcionario=funcionario.id_funcionario and estado_dia_mujer_23=1 and funcionario.id_funcionario=".$_SESSION['snr']."  ORDER BY id_dia_mujer_23 desc  "; //LIMIT 500 OFFSET ".$pagina."
}
...
echo '<td>'.$row['nombre_dia_mujer_23'].'</td>';
echo '<td>'.$row['transporte'].'</td>';
echo '<td>';

if (1==$_SESSION['rol'] or 0<$nump145) { 
echo ' <a style="color:#ff0000;cursor: pointer" title="Borrar" name="dia_mujer_23" id="'.$id_res.'" class="borrar_f"><span class="glyphicon glyphicon-trash"></span></a>';
	} else {}
echo '</td>';
?>
...
<select class="form-control" name="nombre_dia_mujer_23" required>
<option></option>

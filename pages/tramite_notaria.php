...
$(document).ready(function() {
 ...
 <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo existencia('tramite_interno'); ?></h3>
 ...
 <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              <h3>
			  <?php echo existencia('procedimiento_interno'); ?></h3>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              <h3>
<?php echo existencia('accion_interna'); ?>

			  </h3>

              <p>Tramites de procedimientos</p>
            </div>
            <div class="icon">
...
$rad=$_GET['i'];
$query="SELECT * FROM tramite_interno where radicado='$rad' and estado_tramite_interno=1 order by id_tramite_interno desc";
$select = mysql_query($query, $conexion);
$row = mysql_fetch_assoc($select);
$total55 = mysql_num_rows($select);
if (0<$total55) {
?>

<form action="tramites.jsp" method="POST" name="fo43543r4354m1">


<div class="col-md-6">
<div class="form-group text-left"> 
<label  class="control-label">Ya existe la asignación del radicado</label> 
</div>
...
<select class="form-control select2" name="id_notaria" >
...
<form action="tramites.jsp" method="POST" name="foewrewrrm1" >
...
<div class="form-group text-left"> 
<label  class="control-label"><span style="color:#ff0000;">*</span> RADICADO:</label> 
<input type="text" class="form-control" name="radicado" required value="<?php if (isset($_GET['i'])) { echo $_GET['i']; } else {  }?>" readonly>
</div>

...
$queryt = sprintf("SELECT count(id_funcionario) as tfuncionario FROM funcionario where id_tipo_oficina<3 and estado_funcionario=1 and id_funcionario=".$funcionarioedl.""); 
...
$varc=1; } 
else if ('Futbol 5 Femenino'==$_POST["nombre_olimpiada23"] && 96>$reglag2) { 
$varc=1; }
...
$varc=1; }
else if ('Voleibol Mixto'==$_POST["nombre_olimpiada23"] && 120>$reglag2) { 
$varc=1; }
else if ('Bolirana Mixto'==$_POST["nombre_olimpiada23"] && 72>$reglag2) { 
$varc=1; }
else if ('Bolos Mixto'==$_POST["nombre_olimpiada23"] && 72>$reglag2) { 
$varc=1; }
else if ('Mini tejo Mixto'==$_POST["nombre_olimpiada23"] && 72>$reglag2) { 
$varc=1; }
else if ('Atletismo femenino (5 Km)'==$_POST["nombre_olimpiada23"] && 8>$reglag2) { 
$varc=1; }
else if ('Atletismo masculino (10 Km)'==$_POST["nombre_olimpiada23"] && 8>$reglag2) { 
$varc=1; }
else if ('Tenis de Mesa masculino'==$_POST["nombre_olimpiada23"] && 8>$reglag2) { 
$varc=1; }
else if ('Tenis de Mesa femenino'==$_POST["nombre_olimpiada23"] && 8>$reglag2) { 
$varc=1; }
else if ('Tenis de campo masculino'==$_POST["nombre_olimpiada23"] && 8>$reglag2) { 
$varc=1; }
else if ('Tenis de campo femenino'==$_POST["nombre_olimpiada23"] && 8>$reglag2) { 
$varc=1; }
...
$varc=1; }
else if ('Natación Masculino (pecho, espalda y libre)'==$_POST["nombre_olimpiada23"] && 10>$reglag2) { 
$varc=1; }
else if ('Natación Femenino (pecho, espalda y libre)'==$_POST["nombre_olimpiada23"] && 10>$reglag2) { 
$varc=1; }
else if ('Ajedrez'==$_POST["nombre_olimpiada23"] && 8>$reglag2) { 
$varc=1; }
else if ('Duatlon'==$_POST["nombre_olimpiada23"] && 10>$reglag2) { 
$varc=1; }
else if ('Patinaje masculino'==$_POST["nombre_olimpiada23"] && 8>$reglag2) { 
$varc=1; }
else if ('Patinaje femenino'==$_POST["nombre_olimpiada23"] && 8>$reglag2) { 
$varc=1; }
...
nombre_olimpiada23, id_funcionario, equipo, pantalon, camiseta, medias, fecha_olimpiada23, url, estado_olimpiada23) 
...
?>
  ...
  <div class="row">
   ...
   <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
            <div class="inner">
              <h3><?php $todaolimpiada23=existencia('olimpiada23'); 
            echo $todaolimpiada23;			  ?></h3>
            ...
            <a href="#" data-toggle="modal" data-target="#popupactualizarolimpiada23" class="small-box-footer">Más info. <i class="fa fa-arrow-circle-right"></i></a>
          </div>
      </div>
 ...
 <h3>20<?php echo $anoactual; ?></h3>
	...
	<?php
	if (4000<=$todaolimpiada23) { echo 'Cupos completados'; } else {
	?>
...
<div class="box-header with-border">
  ...
  <p>
<b> Formulario de PREINSCRIPCIÓN a  Juegos Deportivos Nacionales SNR 2023:</b>
...
$fecha_limite = strtotime("2023-03-31 12:00:00");
...
$query4="SELECT * from olimpiada23, funcionario where olimpiada23.id_funcionario=funcionario.id_funcionario and estado_olimpiada23=1 ".$infop." ORDER BY id_olimpiada23 desc  "; //LIMIT 500 OFFSET ".$pagina."
} else {
$query4="SELECT * from olimpiada23, funcionario where olimpiada23.id_funcionario=funcionario.id_funcionario and estado_olimpiada23=1 and funcionario.id_funcionario=".$_SESSION['snr']." ORDER BY id_olimpiada23 desc  "; //LIMIT 500 OFFSET ".$pagina."
}
...
echo '<td>';
//echo ' <a href="filesnr/olimpiada23/'.$row['url'].'" target="_blank"><img src="images/pdf.png"></a>';
	if (1==$_SESSION['rol'] or 0<$nump111) { 

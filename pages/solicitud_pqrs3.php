...
if (0<$totalRows){
do {
	echo '<option value="'.$row['id_notaria'].'">'.$row['nombre_notaria'].'</option>';
	 } while ($row = mysql_fetch_assoc($select)); 
} else {}	 
mysql_free_result($select);
 ?>
...
if (5!=$estado_solicitud_pqrs &&  ((0<$sigrupo && 45==$_SESSION['snr_grupo_area'] && 1==$_SESSION['snr_grupo_cargo']) or 1==$_SESSION['rol'])) {

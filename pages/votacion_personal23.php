...
$fecha_inicio = strtotime("2023-02-21 07:58:00");
$fecha_limite = strtotime("2023-02-21 16:58:00");
...
$selectu = mysql_query("SELECT id_funcionario, nombre_funcionario, correo_funcionario from funcionario where id_vinculacion in (1, 2, 7) and id_funcionario=".$valor." limit 1", $conexion);
...
$selectu = mysql_query("select count(id_votacion_personal23) as totale from votacion_personal23 where id_funcionario=".$idf." and estado_votacion_personal23=1", $conexion);
$rowu = mysql_fetch_assoc($selectu);
...
$insertSQL = sprintf("INSERT INTO votacion_personal23 
(nombre_votacion_personal23, id_candidato_votacion_personal23, id_funcionario, fecha_votacion_personal23, estado_votacion_personal23) 
VALUES (%s, %s, %s, %s, %s)", 
...
$cuerpo2 .= 'La Superintendencia de Notariado y Registro informa que se ha registrado correctamente el voto a la comisión de personal.<br><br>';
...
$query = "SELECT * FROM candidato_votacion_personal23, funcionario WHERE candidato_votacion_personal23.id_funcionario=funcionario.id_funcionario and estado_candidato_votacion_personal23=1 ";
...
$idv=$row['id_candidato_votacion_personal23'];
...
<?php echo '<center><img src="files/'.$foto.'" style="width:100px;"></center>
<br>'.$name.''; ?>        
			  <br>
              <b>Candidato</b>
            </div>
...
<?php } else { echo 'No tiene acceso, solo para funcionarios de carrera administrativa y libre nombramiento.'; }

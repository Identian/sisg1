...
$ruta_archivo = 'instruccion_admin-'.$_POST["numero_archivo"].'-'.date("YmdGis");
...
GetSQLValueString('instruccion_admin', "text"),
  ...
  <div class="row">
   ...
   <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo existenciaunica('archivo', 'id_normatividad', 5); ?></h3>
...
$query4="SELECT * from archivo where estado_archivo=1 ".$infop." and id_normatividad=5 ORDER BY fecha_publicacion desc  "; //LIMIT 500 OFFSET ".$pagina."

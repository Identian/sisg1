...
if (3 > $_SESSION['snr_tipo_oficina']) {
  ...
  if ((isset($_POST["celular_funcionario"])) && ("" != $_POST["celular_funcionario"]) &&
    ...
    if (0 < $rowtt['tfuncionario']) {
      ...
      $query = sprintf("SELECT count(id_dia_registrador_24) as tdia_registrador_24 FROM dia_registrador_24 where estado_dia_registrador_24=1 and id_funcionario=" . $_SESSION['snr'] . "");
      $select = mysql_query($query, $conexion);
      $rowt = mysql_fetch_assoc($select);
      if (0 < $rowt['tdia_registrador_24']) {
        ...
        if (isset($_FILES['file']['name']) && "" != $_FILES['file']['name']) {
          ...
          $ruta_archivo = 'dia_registrador-24' . $_SESSION['snr'] . '' . date("YmdGis");
          ...
          if ($tamano_archivo >= intval($tam_archivo2)) {
            ...
            if (($extension2 == $extension)) {
              ...
              echo $insertSQL = sprintf(
                "INSERT INTO dia_registrador_24 (id_funcionario, ciudad_origen,  transporte, camiseta, alimento, nombre_alimento, alergia, nombre_alergia, movilidad, nombre_movilidad, url, estado_dia_registrador_24) 
              ...
              $subject = 'CONFIRMACIÓN DE INSCRIPCIÓN AL DIA DEL REGISTRADOR 2024';
              $cuerpo2 = '';
              ...
              $cuerpo2 .= 'Vicky de la Superintendencia de Notariado y Registro informa que se ha registrado correctamente la inscripción al dia del registrador 2024.<br><br>';
  ...
  <div class="row">
    <div class="col-lg-3 col-xs-6">
      <div class="small-box bg-red">
        <div class="inner">
          <h3><?php echo existencia('dia_registrador_24'); ?></h3>
          <p>Registros</p>
        </div>
        <div class="icon">
    ...
    <div class="col-md-12">
      <div class="box box-primary">
        <div class="box-header with-border">
          <div class="col-md-12">
            <p>
              <b> Inscripción al dia del Registrador 2024:</b>
              <br>
              <br>
              <b>
            ...
            <table class="table display" id="inforesoluciones" cellspacing="0" width="100%">
              ...
              <tbody>
                ...
                if (1 == $_SESSION['rol'] or 0 < $nump111) {
                  $query4 = "SELECT * from dia_registrador_24, funcionario where dia_registrador_24.id_funcionario=funcionario.id_funcionario and estado_dia_registrador_24=1 " . $infop . " ORDER BY id_dia_registrador_24 desc  "; //LIMIT 500 OFFSET ".$pagina."
                } else {
                  $query4 = "SELECT * from dia_registrador_24, funcionario where dia_registrador_24.id_funcionario=funcionario.id_funcionario and estado_dia_registrador_24=1 and funcionario.id_funcionario=" . $_SESSION['snr'] . " ORDER BY id_dia_registrador_24 desc  "; //LIMIT 500 OFFSET ".$pagina."
                }
                ...
                ?>
                  <tr>
                    <?php
                    $id_res = $row['id_dia_registrador_24'];
                    echo '<td>' . $row['fecha_dia_registrador_24'] . '</td>';
                    ...
                    echo '<td>';
                    //echo ' <a href="" class="buscardia_registrador_24" id="'.$id_res.'" title="Actualizar" data-toggle="modal" data-target="#popupactualizardia_registrador_24"> <i class="fa fa-edit"></i></a> ';
                    echo ' <a href="filesnr/diaregistrador/' . $row['url'] . '" target="_blank" > <i class="fa fa-file"></i></a> ';

                    //or 0<$nump111
                    if (1 == $_SESSION['rol'] or 0 < $nump111) {
                      echo ' <a style="color:#ff0000;cursor: pointer" title="Borrar" name="dia_registrador_24" id="' . $id_res . '" class="borrar_f"><span class="glyphicon glyphicon-trash"></span></a>';
                    } else {
                    }
                    echo '</td>';
                    ?>

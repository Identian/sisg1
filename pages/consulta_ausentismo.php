...
//          $hash=md5($files);
            $id_tipo_docto_ausentismo = $_POST['id_tipo_docto_ausentismo']; // 0 = Evidencia 1 = Resolución
      ...
      <div class="container-fluid">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
			    <li><a href="ausentismo.jsp"><p style="font-size: 18px"><b>AUSENTISMO</b></p></a></li>
            </ul>
        </div>
    ...
    <div class="col-md-12">
          <div class="box  box-info">
			 ...
			 <div class="row-md-6 text-left">
				 ...
				 <?php if(($id_aprobacion_ausentismo < 6) or (1==$_SESSION['rol'])) { ?>
    		     <a id="" class="ventana1" data-toggle="modal" data-target="#mofiausen" href="" title="Modificar Ausentismo"> <button type="button" class="btn btn-xs btn-warning"><span class="glyphicon glyphicon-pencil"></span> Modificar</button></a>
				  <?php } ?>  
             </div>
			   ...
			   <div class="box box-primary">
                  <div class="box-header with-border">
                       <h4>
					       <?php 
						   $totre = 0;
						   $query52 = sprintf("SELECT COUNT(id_ausentismo) AS totre
	                       FROM docto_ausentismo
                           WHERE id_ausentismo = '$id_ausentismo'  
                           AND id_tipo_docto_ausentismo = 1
...
<div id="nuevaAventura" class="modal-body"> 
  <form action="" method="POST" name="form43534543555" enctype="multipart/form-data">
    ...
    <div class="form-group text-left"> 
        ...
        <select class="form-control" name="id_tipo_docto_ausentismo">

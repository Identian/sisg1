...
$selectu = mysql_query("SELECT id_funcionario, nombre_funcionario, correo_funcionario from funcionario where (id_tipo_oficina=3 or id_rol=1)  and id_funcionario=".$valor." limit 1", $conexion);
...
$selectu = mysql_query("select count(id_votacion_juntacn) as totale from votacion_juntacn where id_funcionario=".$idf." and estado_votacion_juntacn=1", $conexion);
$rowu = mysql_fetch_assoc($selectu);
...
$insertSQL = sprintf("INSERT INTO votacion_juntacn 
(nombre_votacion_juntacn, id_candidato_votacion_juntacn, id_funcionario, fecha_votacion_juntacn, estado_votacion_juntacn) 
VALUES (%s, %s, %s, %s, %s)", 
...
$query = "SELECT * FROM candidato_votacion_juntacn, funcionario WHERE candidato_votacion_juntacn.id_funcionario=funcionario.id_funcionario and estado_candidato_votacion_juntacn=1 ";
...
$idv=$row['id_candidato_votacion_juntacn'];
...
<?php } else { echo '<br>Solo para personal de Notarias.'; }

} else { echo '<br>Solo para personal de Notarias.'; }
 ?>
...
$fecha_inicio = strtotime("2021-03-02 08:00:00");
$fecha_limite = strtotime("2021-03-02 17:00:00");
...
$selectu = mysql_query("SELECT id_funcionario, nombre_funcionario, correo_funcionario from funcionario where id_vinculacion in (2) and id_funcionario=".$valor." limit 1", $conexion);
...
$selectu = mysql_query("select count(id_votacion_personal) as totale from votacion_personal where id_funcionario=".$idf." and estado_votacion_personal=1", $conexion);
$rowu = mysql_fetch_assoc($selectu);
...
$insertSQL = sprintf("INSERT INTO votacion_personal 
(nombre_votacion_personal, id_candidato_votacion_personal, id_funcionario, fecha_votacion_personal, estado_votacion_personal) 
VALUES (%s, %s, %s, %s, %s)", 
...
$query = "SELECT * FROM candidato_votacion_personal, funcionario WHERE candidato_votacion_personal.id_funcionario=funcionario.id_funcionario and estado_candidato_votacion_personal=1 ";
...
$idv=$row['id_candidato_votacion_personal'];
...
<?php } else { echo 'No tiene acceso, solo para funcionarios de carrera administrativa.'; }

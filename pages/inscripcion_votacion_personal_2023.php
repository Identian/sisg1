...
$queryk = "SELECT count(id_funcionario) as totp FROM funcionario where id_vinculacion=2 and id_funcionario=".$_GET["i"].""; 
...
$queryk = "SELECT count(id_funcionario) as totp FROM funcionario where id_vinculacion=2 and  id_funcionario=".$_SESSION['snr'].""; 
$selectk = mysql_query($queryk, $conexion);
$rowpk = mysql_fetch_assoc($selectk);
$valp=$rowpk['totp'];
mysql_free_result($selectk);
...
$select = mysql_query("select count(id_candidato_votacion_personal23) as totale from candidato_votacion_personal23 where id_funcionario=".$idf1." and estado_candidato_votacion_personal23=1", $conexion);
...
$insertSQL = sprintf("INSERT INTO candidato_votacion_personal23 (nombre_candidato_votacion_personal23, 
id_funcionario, url, estado_candidato_votacion_personal23) VALUES (now(), %s, %s, %s)", 
...
$subject = 'Inscripción a Votación de la comisión de personal';
$cuerpo = ''; 
...
$cuerpo .= 'La superintendencia de notariado y registro informa que se ha registrado correctamente una inscripcion como candidato a las elecciones de la comisión de personal.';
$cuerpo .= "<br><br>"; 
$cuerpo .= "Funcionario: ".$_SESSION['snr_nombre']; 
$cuerpo .= "<br><br>"; 
$cuerpo .= 'Incripción: <a href="https://sisg.supernotariado.gov.co/inscripcion_votacion_personal_2023.jsp">Ver inscripción</a>'; 
$cuerpo .= "<br><br>";  
...
<h3 class="box-title">INSCRIPCIÓN A VOTACIÓN / COMISIÓN DE PERSONAL 2023</h3>
...
$selecti = mysql_query("select * from candidato_votacion_personal23, funcionario where candidato_votacion_personal23.id_funcionario=funcionario.id_funcionario and candidato_votacion_personal23.id_funcionario=".$id." and estado_candidato_votacion_personal23=1 limit 1", $conexion);
$rowi = mysql_fetch_assoc($selecti);
$numvota= mysql_num_rows($selecti);
if (0<$numvota) {

$idv=$rowi['id_candidato_votacion_personal23'];
...
<?php 
echo 'Fecha de inscripción: '.$rowi['nombre_candidato_votacion_personal23'].'<br>';
...
<div class="col-md-6">
	...
	<div class="box box-widget with-border widget-user-2">
            ...
            <div class="widget-user-header bg-success" >
              ...
              <h5 class="widget-user-desc">Incripción hecha.</h5>
            </div>
...
$query = "SELECT * FROM funcionario where id_funcionario=".$id." and id_vinculacion=2 limit 1";
...
<label  class="control-label"><span style="color:#ff0000;">*</span> SOLICITUD: <a href="files/portal/intranet/portal-inscripcion_votacion_personal2023.docx">Descargar formato</a></label> 
...
} else { echo 'No tiene acceso. Solo para funcionarios de carrera administrativa';}


} else { echo 'Paso el plazo de inscripción'; }
 ?>

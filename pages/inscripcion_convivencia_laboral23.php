...
$fecha_inicio = strtotime("2023-03-13 08:00:00");
$fecha_limite = strtotime("2023-03-17 17:00:00");
...
$queryk = "SELECT count(id_funcionario) as totp FROM funcionario where id_tipo_oficina<3 and id_vinculacion in (2, 3, 4, 7) and id_funcionario=".$_GET["i"].""; 
...
$queryk = "SELECT count(id_funcionario) as totp FROM funcionario where id_tipo_oficina<3 and id_vinculacion in (2, 3, 4, 7) and  id_funcionario=".$_SESSION['snr'].""; 
$selectk = mysql_query($queryk, $conexion);
$rowpk = mysql_fetch_assoc($selectk);
$valp=$rowpk['totp'];
mysql_free_result($selectk);
...
$select = mysql_query("select count(id_candidato_votacion_convivencia23) as totale from candidato_votacion_convivencia23 where id_funcionario=".$idf1." and estado_candidato_votacion_convivencia23=1", $conexion);
...
$insertSQL = sprintf("INSERT INTO candidato_votacion_convivencia23 (nombre_candidato_votacion_convivencia23, 
id_funcionario, url, estudio, nombre_estudio, estado_candidato_votacion_convivencia23) VALUES (now(), %s, %s, %s, %s, %s)", 
GetSQLValueString($_SESSION['snr'], "int"),  
GetSQLValueString($files, "text"), 
GetSQLValueString($_POST['estudio'], "text"), 
GetSQLValueString($_POST['nombre_estudio'], "text"), 
...
$subject = 'Inscripción a Votación del comite de convivencia laboral 2023';
$cuerpo = ''; 
...
$cuerpo .= 'La superintendencia de notariado y registro informa que se ha registrado correctamente una inscripcion como candidato a las elecciones del comite de convivencia laboral 2023.';
$cuerpo .= "<br><br>"; 
$cuerpo .= "Funcionario: ".$_SESSION['snr_nombre']; 
$cuerpo .= "<br><br>"; 
$cuerpo .= 'Incripción: <a href="https://sisg.supernotariado.gov.co/inscripcion_convivencia_laboral23.jsp">Ver inscripción</a>'; 
$cuerpo .= "<br><br>";  
...
<h3 class="box-title">INSCRIPCIÓN A VOTACIÓN / COMITE DE CONVIVENCIA LABORAL 2023</h3>
...
<button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
			...
			[ELECCIONES 2023-2025] COMITÉ DE CONVIVENCIA LABORAL 
			<a href="files/resoluciones/res-1485-20230309114721.pdf" target="_blank">Resolución</a>
			<hr>
...
$selecti = mysql_query("select * from candidato_votacion_convivencia23, funcionario where candidato_votacion_convivencia23.id_funcionario=funcionario.id_funcionario and candidato_votacion_convivencia23.id_funcionario=".$id." and estado_candidato_votacion_convivencia23=1 limit 1", $conexion);
$rowi = mysql_fetch_assoc($selecti);
$numvota= mysql_num_rows($selecti);
if (0<$numvota) {

$idv=$rowi['id_candidato_votacion_convivencia23'];
...
<?php 
echo 'Fecha de inscripción: '.$rowi['nombre_candidato_votacion_convivencia23'].'<br>';
...
<label  class="control-label"><span style="color:#ff0000;">*</span> Nivel de estudio (TERMINADO)</label> 
...
<div class="form-group ">
<label  class="control-label"> Profesión o nombre del postgrado.</label> 
...
<label  class="control-label"><span style="color:#ff0000;">*</span> SOLICITUD FIRMADA: <a href="files/portal/intranet/portal-formato_inscripcion_comite23.docx">Descargar modelo</a></label> 
...
<div class="box box-widget with-border widget-user-2">
            <!-- Add the bg color to the header using any of the bg-* classes -->
            <div class="widget-user-header bg-success" >
		<?php	if ('avatar.png'==$foto) { echo '<b style="color:#B40404"> - - - Debe subir su foto en el sistema. - - - - -- </b>'; } else { ?>
              <div class="widget-user-image">
...
} else { echo 'No se encuentra activo el módulo.';}
 ?>

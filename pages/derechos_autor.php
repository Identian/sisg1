...
if (0<$rowtt['tfuncionario']) {
	...
	$query = sprintf("SELECT count(id_derecho_autor) as tderecho_autor FROM derecho_autor where estado_derecho_autor=1 and id_funcionario=".$_SESSION['snr'].""); 
$select = mysql_query($query, $conexion);
$rowt = mysql_fetch_assoc($select);
if (0<$rowt['tderecho_autor']) {
...
$insertSQL = sprintf("INSERT INTO derecho_autor (
nombre_derecho_autor, id_funcionario, estado_derecho_autor) 
VALUES (now(), %s, %s)", 
...
echo $insertado;
  ...
  $updateSQL = sprintf("UPDATE funcionario SET  celular_funcionario=%s, sexo=%s, fecha_nacimiento=%s WHERE id_funcionario=%s and estado_funcionario=1",
  ...
  <div class="row">
   ...
   <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
            <div class="inner">
              <h3><?php echo existencia('derecho_autor'); ?></h3>
...
<div class="box-header with-border">
  ...
  <p>
<b>  Inscripción a capacitación en derechos de autor:</b>

<br>
A través de esta capacitación, se resaltarán los aspectos más importantes del derecho de 
autor en las nuevas tecnologías. Se profundizará en el ejercicio de los derechos morales, 
patrimoniales y las limitaciones y excepciones en el entorno digital. Así mismo, se 
presentarán algunas condiciones específicas del derecho de autor frente al software.
</p>
...
$query4="SELECT * from derecho_autor, funcionario where derecho_autor.id_funcionario=funcionario.id_funcionario and estado_derecho_autor=1 ".$infop." ORDER BY id_derecho_autor desc  "; //LIMIT 500 OFFSET ".$pagina."
} else {
$query4="SELECT * from derecho_autor, funcionario where derecho_autor.id_funcionario=funcionario.id_funcionario and estado_derecho_autor=1 and funcionario.id_funcionario=".$_SESSION['snr']." ORDER BY id_derecho_autor desc  "; //LIMIT 500 OFFSET ".$pagina."
}
...
<tr>
				<?php
$id_res=$row['id_derecho_autor'];
echo '<td>'.$row['nombre_derecho_autor'].'</td>';
...
//or 0<$nump111
	if (1==$_SESSION['rol'] or 0<$nump111) { 
echo ' <a style="color:#ff0000;cursor: pointer" title="Borrar" name="derecho_autor" id="'.$id_res.'" class="borrar_f"><span class="glyphicon glyphicon-trash"></span></a>';
...
<div class="modal fade" id="popupactualizarderecho_autor" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
...
<div id="ver_actualizarderecho_autor" class="modal-body"> 

...
$fecha_f = strtotime("2022-11-09 17:00:00");
 if ($fecha_actual<$fecha_f) {
	 
if ((1==$_SESSION['rol']) and isset($_GET["i"]) && 1==2) {
...
$select = mysql_query("select count(id_candidato_votacion_fc2022) as totale from candidato_votacion_fc2022 where (id_funcionario1=".$idf1." or id_funcionario2=".$idf1." or  id_funcionario1=".$idf2." or id_funcionario2=".$idf2." ) and estado_candidato_votacion_fc2022=1", $conexion);
...
$insertSQL = sprintf("INSERT INTO candidato_votacion_fc2022 (nombre_candidato_votacion_fc2022, 
id_funcionario1, id_funcionario2, id_notaria1, id_notaria2, url, estado_candidato_votacion_fc2022) 
...
$cuerpo .= 'La Superintendencia de Notariado y Registro informa que se ha registrado correctamente una inscripción como candidato a las elecciones de representantes de notarios de tercera categoria ante el FCEN 2022.';
$cuerpo .= "<br><br>"; 
...
$cuerpo2 .= 'La Superintendencia de Notariado y Registro informa que se ha registrado correctamente una inscripción como candidato a las elecciones de representantes de notarios de tercera categoria ante el FCEN 2022.';
$cuerpo2 .= "<br><br>"; 
$cuerpo .= "Notaria: ".$nombre_notaria; 
$cuerpo .= "<br><br>"; 
...
<h3 class="box-title">INSCRIPCIÓN A VOTACIÓN FONDO CUENTA 2022</h3>
...
$selecti = mysql_query("select * from candidato_votacion_fc2022 where (id_funcionario1=".$id." or id_funcionario2=".$id." ) and estado_candidato_votacion_fc2022=1 limit 1", $conexion);
...
$idv=$rowi['id_candidato_votacion_fc2022'];
...
<?php 
echo 'Fecha de inscripción: '.$rowi['nombre_candidato_votacion_fc2022'].'<br>';
...
<label  class="control-label"><span style="color:#ff0000;">*</span> SOLICITUD: <a href="files/portal/intranet/portal-fcen_2022.docx">Descargar modelo</a></label> 
...
<?php } else { echo 'No tiene acceso, funcionalidad solo para Notarios.';}
 } else { echo 'La fecha de la inscripción no ha iniciado.'; }
 ?>

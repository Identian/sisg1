   ...
   <div class="col-lg-3 col-xs-6">
    <div class="small-box bg-red">
            <div class="inner">
              <h3>
			  <?php	  
			  echo existencia('votacion_cscn_2022');
...
$fecha_inicio = strtotime("2022-10-21 14:28:00");
//1==$_SESSION['rol'] or 
//echo $fecha_inicio.'<'.$fecha_actual;
...
$query4="
SELECT * 
FROM notaria, posesion_notaria, funcionario, votacion_cscn_2022 WHERE votacion_cscn_2022.id_funcionario=funcionario.id_funcionario and 
...
$query4="SELECT id_candidato_votacion_cscn_2022, fecha_votacion_cscn_2022, nombre_funcionario, correo_funcionario, id_notaria, nombre_votacion_cscn_2022 
from votacion_cscn_2022, funcionario where votacion_cscn_2022.id_funcionario=funcionario.id_funcionario and estado_votacion_cscn_2022=1";
...
if (1==intval($row['id_candidato_votacion_cscn_2022'])) {
	array_push($var1, 1);
}	else if (2==intval($row['id_candidato_votacion_cscn_2022'])) {
		array_push($var2, 2);
	}	else if (3==intval($row['id_candidato_votacion_cscn_2022'])) {
			array_push($var3, 3);
		}	else{}
		
		
echo '<td>'.$row['fecha_votacion_cscn_2022'].'</td>';
...
echo '<td>'.$row['nombre_votacion_cscn_2022'].'</td>';
...
LUIS EFREN LEYTON CRUZ - Principal, PAULINA GOMEZ GONZALEZ - Suplente<br>
<?php //echo intval(array_sum($var1));  ?>280
</div>


<div class="form-group text-left siimpedimento"> 
<label  class="control-label"> Plancha 2:</label> 
MAURICIO EDUARDO GARCIA HERREROS CASTAÑEDA - Principal, MARCO TULIO SINISTERRA HURTADO - Suplente<br>
<?php //echo intval(array_sum($var2)); ?>41
</div>

<div class="form-group text-left siimpedimento"> 
<label  class="control-label"> Plancha 3:</label> 
RICARDO CORREA CUBILLOS - Principal, RENE ARMANDO ANDRADE REDONDO - Suplente<br>
<?php //echo intval(array_sum($var3)); ?>233
</div>

...
$actualizar5 = mysql_query("SELECT * FROM notaria where id_departamento='$coddep' and codigo_municipio='$codmun' and  estado_notaria=1 order by codigo_notaria", $conexion) or die(mysql_error());
$row15 = mysql_fetch_assoc($actualizar5);
$total55 = mysql_num_rows($actualizar5);
if (0<$total55) {
 echo '<option value="" selected>-- Seleccionar --</option>';

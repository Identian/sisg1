    ...
    <div class="row" style="margin:20px 5px;">
      <div class="table-responsive" style="height: 600px;">
        ...
        <?php if (0 == $privilegio) { ?>
          ...
          <table class="table table-striped table-bordered table-hover" id="TablaInsumo" cellspacing="0" width="100%">
            <thead>
                ...
                if (0 < $totalRows) {
                  do {
                    if (isset($rowD['id_oficina_registro'])) {
                      ...
                      WHERE gsa_solicitud.id_gsa_solicitud = $idSolicitud AND gsa_solicitud_insumo.id_oficina_registro = $oficinaR";
                      ...
                      if ($rowCount['conta'] > 0) {
                        ...
                        if (1 == $estadoSnr) { ?>
                          ...
                          if (isset($rowD['id_punto_ubicacion'])) {
                            ...
                            LEFT JOIN gsa_solicitud_insumo
                            ON gsa_solicitud.id_gsa_solicitud = gsa_solicitud_insumo.id_solicitud
                            WHERE gsa_solicitud.id_gsa_solicitud = $idSolicitud AND gsa_solicitud_insumo.id_punto_ubicacion = $puntoUbicacion";
            ...
            <tbody>
              ...
              WHERE gsa_solicitud.id_gsa_solicitud = $idSolicitud AND gsa_producto.producto_estado=1 AND gsa_producto.estado_gsa_producto=1";
              $select = mysql_query($query, $conexion);
              ...
              if (0 < $totalRows) {
                do {
                  ...
                  $querycantidad = "SELECT SUM(cantidad_producto) AS sumaCantidad FROM gsa_solicitud_insumo 
                  LEFT JOIN gsa_solicitud
                  ON gsa_solicitud.id_gsa_solicitud=gsa_solicitud_insumo.id_solicitud
                  WHERE gsa_solicitud_insumo.id_solicitud=$idSolicitud AND gsa_solicitud_insumo.id_gsa_producto=$idproducto";
                  ...
                  $querydetalle = "SELECT * FROM gsa_solicitud_insumo
                  LEFT JOIN gsa_producto
                  ON gsa_solicitud_insumo.id_gsa_producto = gsa_producto.id_gsa_producto
                  WHERE gsa_solicitud_insumo.id_gsa_producto=$idproducto AND  gsa_solicitud_insumo.id_solicitud=$idSolicitud AND gsa_solicitud_insumo.estado_gsa_solicitud_insumo=1";
                    ...
                    do {
                      if (0 == $estadoSnr) { ?>
                        <td style="text-align: center;">
                          <input style="width:50px; text-align: center; border-radius:0px; border:solid 1px #999;" type="number" value="<?php echo $rowdetalle1['cantidad_producto']; ?>" onchange="cambiocantidad('cantidad_insumo', this.value, <?php echo $rowdetalle1['id_gsa_solicitud_insumo']; ?>);" />
          ...
          <table class="table table-striped table-bordered table-hover" id="cantidadProductos" cellspacing="0" width="100%">
            <thead>
              <tr style="background-color: #eee;">
                <th>Cod</th>
                <th>Item</th>
                <th>Cantidad Enviada (SNR)</th>
                <th>Cantidad Recibida</th>
                <th>Revisión - Faltante</th>
              </tr>
            </thead>
            <tbody>
              <?php
              if (1 == $privilegio) {
                $queryoficinapunto = 'gsa_solicitud_insumo.id_oficina_registro=' . $oficinaRegistro . '';
              }
              if (2 == $privilegio) {
                $queryoficinapunto = 'gsa_solicitud_insumo.id_punto_ubicacion=' . $puntoUbicacion . '';
              }
              $totalFacturacion = 0;
              $query = "SELECT * FROM gsa_solicitud
              LEFT JOIN gsa_orden
              ...
              LEFT JOIN gsa_solicitud_insumo
              ON gsa_solicitud_insumo.id_gsa_producto=gsa_producto.id_gsa_producto
              WHERE gsa_solicitud.id_gsa_solicitud = $idSolicitud AND gsa_solicitud_insumo.id_solicitud = $idSolicitud AND $queryoficinapunto AND gsa_solicitud_insumo.cantidad_producto > 0 AND gsa_solicitud_insumo.estado_gsa_solicitud_insumo=1";
              $select = mysql_query($query, $conexion);
              ...
              if (0 < $totalRows) {
                do {
                  echo '<tr>';
                  echo '<td>' . $rowD2['numero_producto'] . '</td>
                  ...
                  if (1 == $privilegio) {
                    ...
                    LEFT JOIN gsa_producto
                    ON gsa_solicitud_insumo.id_gsa_producto=gsa_producto.id_gsa_producto
                    WHERE gsa_solicitud_insumo.id_gsa_producto=$idproducto AND gsa_solicitud_insumo.id_solicitud=$idSolicitud AND gsa_solicitud_insumo.id_oficina_registro=$oficinaRegistro AND estado_gsa_solicitud_insumo=1";
                  }
                  if (2 == $privilegio) {
                    ...
                    LEFT JOIN gsa_producto
                    ON gsa_solicitud_insumo.id_gsa_producto=gsa_producto.id_gsa_producto
                    WHERE gsa_solicitud_insumo.id_gsa_producto=$idproducto AND gsa_solicitud_insumo.id_solicitud=$idSolicitud AND gsa_solicitud_insumo.id_punto_ubicacion=$puntoUbicacion AND estado_gsa_solicitud_insumo=1";
                  }
                  $selectdetalle = mysql_query($querydetalle, $conexion);
                  ...
                  if (0 < $detalleRows) {
                    do {
                      ...
                      if (0 === $estadoNumVerifica) { ?>
                        <td style="text-align: center;">
                          <input style="width:50px; text-align: center; border-radius:0px; border:solid 1px #999;" type="number" value="<?php echo $rowdetalle2['cantidad_verifica']; ?>" onchange="cambioverifica('verifica_insumo', this.value, <?php echo $rowdetalle2['id_gsa_solicitud_insumo']; ?>);" />
                        </td> <?php
                            }
                ...
                $(document).ready(function() {
                  $('#cantidadProductos').DataTable({
                    ...
                    buttons: [{
                      extend: 'pdfHtml5',
                      text: 'PDF',
                      title: "REMISIÓN INSUMOS <?php echo $NombreImpreso; ?>",

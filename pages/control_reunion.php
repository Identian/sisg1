...
<div class="col-md-12">
<h3  class="box-title">
Control de reuniones de la SNR
</h3>
</div>
</div> 
    <div class="box-body">
...
<form action="" method="POST" name="for54354r65354645345464324324563m1" >
...
<input type="text" class="form-control" readonly value="<?php echo $realdate; ?>">
</div>


<div class="form-group text-left"> 
<label  class="control-label"><span style="color:#ff0000;">* Ayudanos a mejorar.</span><br>
De 1 a 5, que tanto considera que la transformación digital en la SNR o vigilados ha mejorado el desempeño de las funciones:</label> <br>
...
<div class="form-group text-left"> 
<label  class="control-label"><span style="color:#ff0000;">* Ayudanos a mejorar.</span><br> 
¿Que efectos o beneficios ha percibido en la SNR o vigilados generados por la transformación digital?:</label> 

		 ...
		 <div class="row">
          <div class="box box-primary">
             <div class="box-header with-border">
                  <h3 class="box-title">Nueva Licencia</h3>
	...
	if (1==$_SESSION['rol']  or 0<$nump144) {  /// solo las 3 p radicación
		 echo '<option>Inicial</option>';
				 ...
				 echo '<option>Revalidación</option>';
				  ...
				  echo '<option>Otras actuaciones</option>';
	} else {
...
<select name="certificado_ocupacion" class="form-control" required >
<option></option>
<option>SI</option>
<option>NO</option>
</select>
...
<select name="autorizacion_ocupacion" class="form-control" required>
<option></option>
<option>SI</option>
<option>NO</option>
</select>
...
<input type="text"  class="form-control datepickercuraduria" readonly="readonly" name="fecha_viabilidad" required  >
</div>
...
<span class="glyphicon glyphicon-ok"></span> SIGUIENTE </button></div>
</div>
</form>

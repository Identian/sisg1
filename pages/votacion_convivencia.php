...
$fecha_inicio = strtotime("2021-02-25 08:00:00");
$fecha_limite = strtotime("2021-02-26 17:00:00");
...
$selectu = mysql_query("SELECT id_funcionario, nombre_funcionario, correo_funcionario from funcionario where id_vinculacion in (1, 2, 3, 4, 7) and id_funcionario=".$valor." limit 1", $conexion);
...
$selectu = mysql_query("select count(id_votacion_convivencia) as totale from votacion_convivencia where id_funcionario=".$idf." and estado_votacion_convivencia=1", $conexion);
$rowu = mysql_fetch_assoc($selectu);
...
$insertSQL = sprintf("INSERT INTO votacion_convivencia 
(nombre_votacion_convivencia, id_candidato_votacion_convivencia, id_funcionario, fecha_votacion_convivencia, estado_votacion_convivencia) 
VALUES (%s, %s, %s, %s, %s)", 
...
$cuerpo2 .= 'La Superintendencia de Notariado y Registro informa que se ha registrado correctamente el voto al comite de convivencia laboral.<br><br>';
...
$query = "SELECT * FROM candidato_votacion_convivencia, funcionario WHERE candidato_votacion_convivencia.id_funcionario=funcionario.id_funcionario and estado_candidato_votacion_convivencia=1 ";
...
$idv=$row['id_candidato_votacion_convivencia'];

...
if (isset($_POST['option']) and "" != $_POST['option']) {
  ...
  <script>
    ...
    function fechaPrograma(tabla, var2, var3) {
      jQuery.ajax({
        type: "POST",
    ...
    function fechaRealiza(tabla, var2, var3) {
      jQuery.ajax({
        type: "POST",
        url: "pages/gsa_actualizar.php",
        data: 'option=' + tabla + '-' + var2 + '-' + var3,
    ...
    function valorServicio(tabla, var2, var3) {
      jQuery.ajax({
        type: "POST",
        url: "pages/gsa_actualizar.php",
        data: 'option=' + tabla + '-' + var2 + '-' + var3,
    ...
    <div class="row" style="margin:20px 5px;">
      <div class="table-responsive" style="height: 600px;">
        ...
        <?php if (0 == $privilegio) { ?>
          ...
          <table class="table table-striped table-bordered table-hover" id="TablaJardineria" cellspacing="0" width="100%">
            ...
            <tbody>
              ...
              gsa_solicitud_jardineria.id_gsa_solicitud_jardineria,
              ...
              LEFT JOIN oficina_registro
              ON oficina_registro.id_oficina_registro=gsa_solicitud_jardineria.id_oficina_registro
              LEFT JOIN punto_ubicacion
              ON punto_ubicacion.id_punto_ubicacion=gsa_solicitud_jardineria.id_punto_ubicacion
              WHERE gsa_solicitud_jardineria.id_solicitud = $idSolicitud";
                  ...
                  if (0 == $estadoSnr) { ?>
                    <td>
                      <?php if (is_null($rowD1['fecha_programa'])) {
                        ...
                        $fechaPrograma = date_create($rowD1['fecha_programa']);
                        $fechaProgramaC = date_format($fechaPrograma, "d/m/Y");
                      } ?>
                      <input style="width:100px; text-align: center; border-radius:0px; border:solid 1px #999;" type="text" id="fecha_programa" name="fecha_programa" value="<?php echo $fechaProgramaC; ?>" onchange="fechaPrograma('fechaPrograma', this.value, <?php echo $rowD1['id_gsa_solicitud_jardineria']; ?>);" placeholder="dia/mes/año" pattern="[0-9/]{10}" title="Formato: dia/mes/año" />
                    </td>
                    <td>
                      <input style="width:150px; text-align: center; border-radius:0px; border:solid 1px #999;" type="number" value="<?php echo $rowD1['valor_servicio']; ?>" onchange="valorServicio('valorServicio', this.value, <?php echo $rowD1['id_gsa_solicitud_jardineria']; ?>);" />
                    </td><?php
                        }
                        $botones = "";
                        if (1 == $estadoSnr) {
                          ...
                          $botones = "
                          {
                            extend: 'excelHtml5',
                            text: 'Excel',
                            title: 'REPORTE JARDINERIA SOLICITUD # " . $rowD1['id_solicitud'] . " DEL PERIODO DESDE " . $rowD1['fecha_inicio'] . " HASTA " . $rowD1['fecha_final'] . "',
                          }";
                        }
            ...
            <script>
              $(document).ready(function() {
                var t = $('#TablaJardineria').DataTable({
                  dom: 'Bfrtip',
                  buttons: [
                    <?php echo $botones; ?>
                  ],
        ...
        <?php } elseif (1 == $privilegio or 2 == $privilegio) { ?>
          ...
          <table class="table table-striped table-bordered table-hover" id="gsaJardineria" cellspacing="0" width="100%">
            <thead>
              <tr style="background-color: #eee;">
                <th>Oficina O Ubicacion</th>
                <th>Fecha Programada</th>
            ...
            <tbody>
              <?php
              if (1 == $privilegio) {
                $queryoficinapunto = 'gsa_solicitud_jardineria.id_oficina_registro=' . $oficinaRegistro . '';
                $NombreImpreso = $NombreoficinaRegistro;
              }
              if (2 == $privilegio) {
                $queryoficinapunto = 'gsa_solicitud_jardineria.id_punto_ubicacion=' . $puntoUbicacion . '';
              ...
              LEFT JOIN punto_ubicacion
              ON punto_ubicacion.id_punto_ubicacion=gsa_solicitud_jardineria.id_punto_ubicacion
              WHERE gsa_solicitud.id_gsa_solicitud = $idSolicitud AND gsa_solicitud_jardineria.id_solicitud = $idSolicitud AND $queryoficinapunto AND gsa_solicitud_jardineria.estado_gsa_solicitud_jardineria=1";
              $select = mysql_query($query, $conexion);
                  ...
                  if (0 == $estadoSnr) {  ?>
                    <td>
                      <?php if (is_null($rowD2['fecha_programa'])) {
                        ...
                        $fechaPrograma = date_create($rowD2['fecha_programa']);
                        $fechaProgramaC = date_format($fechaPrograma, "d/m/Y");
                      } ?>
                      <input style="width:100px; text-align: center; border-radius:0px; border:solid 1px #999;" type="text" value="<?php echo $fechaProgramaC; ?>" onchange="fechaPrograma('fechaPrograma', this.value, <?php echo $rowD2['id_gsa_solicitud_jardineria']; ?>);" placeholder="dia/mes/año" pattern="[0-9/]{10}" title="Formato: dia/mes/año" />
                    </td>
                    <td>
                      <input style="width:150px; text-align: center; border-radius:0px; border:solid 1px #999;" type="number" value="<?php echo $rowD2['valor_servicio']; ?>" onchange="valorServicio('valorServicio', this.value, <?php echo $rowD2['id_gsa_solicitud_jardineria']; ?>);" />
                    </td><?php
                        }
                        if (1 == $estadoSnr) {
                    ...
                    <td>
                      <?php if (is_null($rowD2['fecha_realiza'])) {
                            ...
                            $fechaPrograma = date_create($rowD2['fecha_realiza']);
                            $fechaProgramaC = date_format($fechaPrograma, "d/m/Y");
                          } ?>
                      <input style="width:100px; text-align: center; border-radius:0px; border:solid 1px #999;" type="text" value="<?php echo $fechaProgramaC; ?>" onchange="fechaRealiza('fechaRealiza', this.value, <?php echo $rowD2['id_gsa_solicitud_jardineria']; ?>);" placeholder="dia/mes/año" pattern="[0-9/]{10}" title="Formato: dia/mes/año" />
                    </td>
                    <td>
                      <input style="width:200px; text-align: center; border-radius:0px; border:solid 1px #999;" type="text" value="<?php echo $rowD2['nombre_personal']; ?>" onchange="nombrePersonal('nombrePersonal', this.value, <?php echo $rowD2['id_gsa_solicitud_jardineria']; ?>);" />
                    </td><?php
                        }
                ...
                $(document).ready(function() {
                  $('#gsaJardineria').DataTable({
                    ...
                    buttons: [{
                      extend: 'pdfHtml5',
                      text: 'PDF',
                      title: "JARDINERIA <?php echo $NombreImpreso; ?>",

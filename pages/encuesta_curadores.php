...
<h3>PRIMERA ENCUESTA - <?php echo $name; ?>
</h3>

<br>
<?php

$query = sprintf("SELECT * FROM encuesta_curadores, respuesta_enc_cur where encuesta_curadores.encuesta=respuesta_enc_cur.encuesta and respuesta_enc_cur.encuesta=1 and encuesta_curadores.id_encuesta_curadores=respuesta_enc_cur.id_encuesta_curadores and id_curaduria=".$curaduria." and estado_respuesta_enc_cur=1 and estado_encuesta_curadores=1 order by orden_pregunta"); 
...
$insertSQLa = "update respuesta_enc_cur set estado_respuesta_enc_cur=0 where encuesta=1 and id_curaduria=".$curaduria."";
$Resulta = mysql_query($insertSQLa, $conexion);


echo $actualizado;
echo '<META HTTP-EQUIV="REFRESH" CONTENT="2;URL=encuesta_curadores&'.$curaduria.'.jsp">';
} else { }
...
$insertSQL = "INSERT INTO respuesta_enc_cur (id_curaduria, encuesta, id_encuesta_curadores, nombre_respuesta_enc_cur, fecha_respuesta, estado_respuesta_enc_cur) VALUES ('$curaduria', 1, '$pregunta', '$respuesta', now(), '1')";
...
<table class="table">
<?php 
$query126 = "select * from encuesta_curadores where encuesta=1 and estado_encuesta_curadores=1 order by orden_pregunta asc";

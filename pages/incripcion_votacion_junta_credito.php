...
$hora=date('H');
//$realdate= "2014-02-24";
//if (17>$hora && $realdate=='2022-07-25') {
...
$queryk = "SELECT count(id_funcionario) as totp FROM funcionario where id_vinculacion!=5 and id_funcionario=".$_GET["i"].""; 
...
$queryk = "SELECT count(id_funcionario) as totp FROM funcionario where id_vinculacion!=5 and id_funcionario=".$_SESSION['snr'].""; 
$selectk = mysql_query($queryk, $conexion);
$rowpk = mysql_fetch_assoc($selectk);
$valp=$rowpk['totp'];
mysql_free_result($selectk);
...
$select = mysql_query("select count(id_candidato_votacion_juntac) as totale from candidato_votacion_juntac where id_funcionario=".$idf1." and estado_candidato_votacion_juntac=1", $conexion);
...
$insertSQL = sprintf("INSERT INTO candidato_votacion_juntac (nombre_candidato_votacion_juntac, 
id_funcionario, url, estado_candidato_votacion_juntac) VALUES (now(), %s, %s, %s)", 
...
$subject = 'Inscripción a Votación de la Junta de credito de Vivienda';
$cuerpo = ''; 
...
$cuerpo .= 'La Superintendencia de Notariado y Registro informa que se ha registrado correctamente una inscripcion como candidato a la junta de credito de vivienda.';
$cuerpo .= "<br><br>"; 
$cuerpo .= "Funcionario: ".$_SESSION['snr_nombre']; 
$cuerpo .= "<br><br>"; 
$cuerpo .= 'Incripción: <a href="https://sisg.supernotariado.gov.co/incripcion_votacion_junta_credito.jsp">Ver inscripción</a>'; 
$cuerpo .= "<br><br>";  
...
<h3 class="box-title">INSCRIPCIÓN A LA JORNADA DE VOTACIÓN / JUNTA DE CREDITO DE VIVIENDA</h3>
...
$selecti = mysql_query("select * from candidato_votacion_juntac, funcionario where candidato_votacion_juntac.id_funcionario=funcionario.id_funcionario and candidato_votacion_juntac.id_funcionario=".$id." and estado_candidato_votacion_juntac=1 limit 1", $conexion);
$rowi = mysql_fetch_assoc($selecti);
$numvota= mysql_num_rows($selecti);
if (0<$numvota) {

$idv=$rowi['id_candidato_votacion_juntac'];
...
<?php 
echo 'Fecha de inscripción: '.$rowi['nombre_candidato_votacion_juntac'].'<br>';
...
$query = "SELECT * FROM funcionario where id_vinculacion!=5 and id_funcionario=".$id." limit 1";
...
<label  class="control-label"><span style="color:#ff0000;">*</span> SOLICITUD: <a href="documentos/formato_junta_credito_2022.docx">Descargar modelo</a></label> 
<input type="file" name="file" id="file" title="Solo PDF" onchange="return fileValidation()" value="" required>
<span style="color:#B40404;font-size:13px;">Adjuntar PDF inferior a 10 Mg / </span>
...
<div class="box box-widget with-border widget-user-2">
            ...
            <div class="widget-user-header bg-success" >
              <div class="widget-user-image">
               <a href="usuario.jsp"><img src="files/<?php echo $foto; ?>" alt="Fotografia" title="Cambiar Foto" style="max-width:300px;"></a>
              </div>
              <!-- /.widget-user-image -->
			  <br>

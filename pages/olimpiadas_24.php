...
$todaolimpiada24 = existencia('olimpiada24');

$realdatecompleto = date('Y-m-d H:i:s');
$fecha_actual = strtotime($realdatecompleto);
$fecha_inicio = strtotime("2024-01-01 08:00:00");
$fecha_limite = strtotime("2024-01-31 12:00:00");

if (837 > $todaolimpiada24) {
  //if (1==$_SESSION['rol'] && 831>$todaolimpiada24) { 
  ...
  if (3 > $_SESSION['snr_tipo_oficina']) {
    ...
    {
      global $mysqli;
      $query4png = sprintf("SELECT count(id_olimpiada24) as contador FROM olimpiada24 where nombre_olimpiada24='$disciplina' and estado_olimpiada24=1");
    ...
    if (((isset($_POST["nombre_olimpiada24"])) && ("" != $_POST["nombre_olimpiada24"]) &&
      ...
      if (0 < $rowtt['tfuncionario']) {
        ...
        $query = sprintf("SELECT count(id_olimpiada24) as tolimpiada24 FROM olimpiada24 where estado_olimpiada24=1 and id_funcionario=" . $funcionarioedl . "");
        $select = mysql_query($query, $conexion);
        $rowt = mysql_fetch_assoc($select);
        if (0 < $rowt['tolimpiada24']) {
          ...
          $reglag2 = disciplina($_POST["nombre_olimpiada24"]);

          $nombre_olimpiada24 = $_POST["nombre_olimpiada24"];

          if ('Futbol 5 Masculino' == $_POST["nombre_olimpiada24"] &&  96 > $reglag2) {
            $varc = 1;
            $grupal = 1;
            $cantidad = 8;
            $contratistas = 3;
            $equipos = 12;
          } else if ('Futbol 5 Femenino' == $_POST["nombre_olimpiada24"] && 32 > $reglag2) {
            $varc = 1;
            $grupal = 1;
            $cantidad = 8;
            $contratistas = 3;
          ...
          /*
          else if ('Baloncesto Femenino'==$_POST["nombre_olimpiada24"] && 96>$reglag2) { 
          $varc=1; $grupal=1; $cantidad=8; $contratistas=3;  $equipos=12;}
          else if ('Baloncesto Masculino'==$_POST["nombre_olimpiada24"] && 96>$reglag2) { 
          $varc=1; $grupal=1; $cantidad=8; $contratistas=3;  $equipos=12; }
          */ else if ('Baloncesto mixto' == $_POST["nombre_olimpiada24"] && 32 > $reglag2) {
            $varc = 1;
            $grupal = 1;
            $cantidad = 8;
            $contratistas = 3;
            $equipos = 4;
          } else if ('Voleibol Mixto' == $_POST["nombre_olimpiada24"] && 80 > $reglag2) {
            $varc = 1;
            $grupal = 1;
            $cantidad = 10;
            $contratistas = 4;
            $equipos = 8;
          } else if ('Bolirana Mixto' == $_POST["nombre_olimpiada24"] && 132 > $reglag2) {
            $varc = 1;
            $grupal = 1;
            $cantidad = 6;
            $contratistas = 3;
            $equipos = 22;
          } else if ('Bolos Mixto' == $_POST["nombre_olimpiada24"] && 192 > $reglag2) {
            $varc = 1;
            $grupal = 1;
            $cantidad = 6;
            $contratistas = 3;
            $equipos = 32;
          } else if ('Mini tejo Mixto' == $_POST["nombre_olimpiada24"] && 132 > $reglag2) {
            $varc = 1;
            $grupal = 1;
            $cantidad = 6;
            $contratistas = 3;
            $equipos = 22;
          } else if ('Atletismo femenino (5 Km)' == $_POST["nombre_olimpiada24"] && 13 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 3;
            $equipos = 13;
          } else if ('Atletismo masculino (10 Km)' == $_POST["nombre_olimpiada24"] && 13 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 3;
            $equipos = 13;
          } else if ('Tenis de Mesa masculino' == $_POST["nombre_olimpiada24"] && 12 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 3;
            $equipos = 10;
          } else if ('Tenis de Mesa femenino' == $_POST["nombre_olimpiada24"] && 12 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 3;
            $equipos = 10;
          } else if ('Tenis de campo masculino' == $_POST["nombre_olimpiada24"] && 9 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 3;
            $equipos = 10;
          } else if ('Tenis de campo femenino' == $_POST["nombre_olimpiada24"] && 9 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 3;
            $equipos = 10;
          } else if ('Billar pool masculino' == $_POST["nombre_olimpiada24"] && 8 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 3;
            $equipos = 10;
          } else if ('Billar pool femenino' == $_POST["nombre_olimpiada24"] && 8 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 3;
            $equipos = 10;
          } else if ('Billar libre masculino' == $_POST["nombre_olimpiada24"] && 8 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 3;
            $equipos = 10;
          } else if ('Billar libre femenino' == $_POST["nombre_olimpiada24"] && 8 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 3;
            $equipos = 10;
          } else if ('Natación Masculino (pecho, espalda y libre)' == $_POST["nombre_olimpiada24"] && 8 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 10;
            $contratistas = 3;
            $equipos = 10;
          } else if ('Natación Femenino (pecho, espalda y libre)' == $_POST["nombre_olimpiada24"] && 8 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 10;
            $contratistas = 3;
            $equipos = 10;
          } else if ('Ajedrez' == $_POST["nombre_olimpiada24"] && 15 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 6;
            $equipos = 16;
          } else if ('Duatlon' == $_POST["nombre_olimpiada24"] && 10 > $reglag2) {
            $varc = 1;
            $grupal = 0;
            $cantidad = 99;
            $contratistas = 3;
          ...
          /*
          else if ('Patinaje masculino'==$_POST["nombre_olimpiada24"] && 10>$reglag2) { 
          $varc=1; $grupal=0; $cantidad=99; $contratistas=3;  $equipos=10;}
          else if ('Patinaje femenino'==$_POST["nombre_olimpiada24"] && 10>$reglag2) { 
          $varc=1; $grupal=0; $cantidad=99; $contratistas=3;  $equipos=10; }
          */ else {
            $varc = 0;
            $grupal = 0;
          ...
          if (1 == 1) {
            ...
            if (isset($_FILES['file']['name']) && "" != $_FILES['file']['name']) {
              ...
              $ruta_archivo = 'olimpiada24-' . $_SESSION['snr'] . '' . date("YmdGis");
              ...
              if ($tamano_archivo >= intval($tam_archivo2)) {
                ...
                if (($extension2 == $extension)) {
                  ...
                  if ('0' == $_POST["equipo2"]) {
                    ...
                    $corre = '<br>Recuerde compartir el codigo unico de equipo a sus compañeros: ' . $code;
                    $permi = 1;
                  } else {
                    ...
                    $query = sprintf("SELECT count(id_olimpiada24) as toli FROM olimpiada24 where estado_olimpiada24=1 and equipo='$equipo' and code='$code' and nombre_olimpiada24='$nombre_olimpiada24'");
                    $select = mysql_query($query, $conexion);
                    $rowt = mysql_fetch_assoc($select);
                    $cante = $rowt['toli'];
                    if (0 < $cante) {
                  ...
                  if (1 == $permi or 0 == $grupal) {
                    ...
                    // EQUIPOS
                    $queryc = sprintf("SELECT count(DISTINCT(equipo)) as tola FROM olimpiada24 where estado_olimpiada24=1 AND nombre_olimpiada24='$nombre_olimpiada24' ");
                    ...
                    if (($equipos > $con and 0 != $_POST['equipo2']) or 1 == $permi) {
                      ...
                      if ($cante < $cantidad) {
                        ...
                        $insertSQL = sprintf(
                          "INSERT INTO olimpiada24 (
                          nombre_olimpiada24, id_funcionario, equipo, pantalon, camiseta, chaqueta, 
                          ciudadr, eps, arl, cemergencia, celuemergencia, alimentos, alergia, medicamento, contratista, 
                          fecha_olimpiada24, url, code, estado_olimpiada24) 
                          VALUES (%s, %s, %s, %s, %s, %s, %s, %s,  %s, %s, %s, %s, %s, %s, %s, now(), %s, %s, %s)",
                          GetSQLValueString($_POST["nombre_olimpiada24"], "text"),
                        ...
                        $updateSQL = sprintf(
                          "UPDATE funcionario SET rh=%s, celular_funcionario=%s, id_estado_civil=%s, fecha_nacimiento=%s  WHERE id_funcionario=%s and estado_funcionario=1",
                        ...
                        $subject = 'CONFIRMACIÓN DE INSCRIPCIÓN A JUEGOS 2024';
                        $cuerpo2 = '';
                        ...
                        $cuerpo2 .= 'Vicky de la Superintendencia de Notariado y Registro informa que se ha registrado correctamente la inscripción a los Juegos Deportivos Nacionales SNR 2024.<br><br>';
                        ...
                        echo '<script type="text/javascript">swal(" Error !", " El equipo ya esta completo.  !", "error");</script>';
                      }
                    ...
                    echo '<script type="text/javascript">swal(" Error !", " El codigo no es correcto con el nombre del equipo.  !", "error");</script>';
                  }
                } else {
                  $files = '';
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6">
        <div class="small-box bg-red">
          <div class="inner">
            <h3><?php echo $todaolimpiada24;  ?></h3>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <div class="col-md-12">
                ...
                <p>
                  <b> Formulario de inscripción a Juegos Deportivos Nacionales SNR 2024:</b>
                ...
                <h3 class="box-title">
                  ...
                  if ($fecha_limite >= $fecha_actual && 837 > $todaolimpiada24 || 1==$_SESSION['rol'] || 8959==$_SESSION['snr'] || 1980==$_SESSION['snr']|| 10873==$_SESSION['snr']) {
                    ...
                    if (in_array($_SESSION['cedula_funcionario'], $array)) {
                      ...
                      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#miModal"><span class="glyphicon glyphicon-plus-sign"></span>
                        Nuevo
                      </button> Juegos Deportivos Nacionales SNR 2024
                      <a href="https://intranet.supernotariado.gov.co/bienestar/juegos-deportivos-nacionales-2024/" target="_blank">Terminos y condiciones - NO CREADO AUN</a><?php
                    }
                  } else {
                    echo '';
                  }
                ...
                <table class="table display" id="inforesoluciones" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    ...
                    if (1 == $_SESSION['rol'] or 0 < $nump111) {
                      $query4 = "SELECT * from olimpiada24, funcionario where olimpiada24.id_funcionario=funcionario.id_funcionario and estado_olimpiada24=1 ORDER BY id_olimpiada24 desc  ";
                    } else {
                      $query4 = "SELECT * from olimpiada24, funcionario where olimpiada24.id_funcionario=funcionario.id_funcionario and estado_olimpiada24=1 and funcionario.id_funcionario=" . $_SESSION['snr'] . " ORDER BY id_olimpiada24 desc  ";
                    }
                    ...
                    ?>
                      <tr>
                        <?php
                        $id_res = $row['id_olimpiada24'];
                        echo '<td>' . $row['fecha_olimpiada24'] . '</td>';
                        ...
                        echo '<td>' . $row['nombre_olimpiada24'] . '</td>';
                        echo '<td>';
                        if (1 == $row['equipo']) {
                        ...
                        if (1 == $_SESSION['rol'] or 0 < $nump111) { //or 0<$nump111
                          echo ' <a style="color:#ff0000;cursor: pointer" title="Borrar" name="olimpiada24" id="' . $id_res . '" class="borrar_f"><span class="glyphicon glyphicon-trash"></span></a>';
              ...
              <div class="modal-body">
                ...
                <form action="" method="POST" name="for54354r653454345345464324324563m1" enctype="multipart/form-data">
                  ...
                  <div class="form-group text-left">
                    ...
                    <input type="text" class="form-control" readonly value="<?php if (5 == $_SESSION['snr_grupo_cargo']) {
                                                                              echo 'Contratista';
                                                                            } else {
                                                                              echo 'Funcionario';
                                                                            } ?>">
                  ...
                  <div class="form-group text-left">
                    ...
                    <select class="form-control" name="nombre_olimpiada24" id="nombre_olimpiada" required>
                  ...
                  <div class="form-group text-left" style="display:none" id="vistaequipo">
                    ...
                    <select class="form-control" name="equipo2" placeholder="" id="tipo_olimpiada">
                      ...
                       <optgroup label="Equipos creados - - - - - - -">
                        <?php
                        $query3 = sprintf("SELECT equipo FROM olimpiada24 where estado_olimpiada24=1 and equipo!=1 and equipo is not null group by equipo order by equipo");
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div id="ver_actualizarolimpiada" class="modal-body">
                <?php
                $query3 = sprintf("SELECT nombre_olimpiada24, COUNT( * ) Total
                FROM olimpiada24 where estado_olimpiada24=1 
                GROUP BY nombre_olimpiada24
                HAVING COUNT( * ) >0");
                $select3 = mysql_query($query3, $conexion);
                $row3 = mysql_fetch_assoc($select3);
                $totalRows3 = mysql_num_rows($select3);
                if (0 < $totalRows3) {
                  do {
                    echo '<li>';
                    if ('1' == $row3['nombre_olimpiada24']) {
                      echo 'Sin equipo: ';
                    } else {
                      echo $row3['nombre_olimpiada24'] . ': ';
                    }
                    echo '' . $row3['Total'] . '</li>';
                  } while ($row3 = mysql_fetch_assoc($select3));
                } else {
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div id="ver_actualizarolimpiada2" class="modal-body">
                ...
                FROM olimpiada24 where equipo is not null and estado_olimpiada24=1 
                GROUP BY equipo
                HAVING COUNT( * ) >0");
                $select3 = mysql_query($query3, $conexion);
                $row3 = mysql_fetch_assoc($select3);
                ...
                <table>
                  ...
                  if (0 < $totalRows3) {
                    do {
                      ...
                      $equip = $row3['nombre_olimpiada24'] . ' ';
                      echo '<tr><td>' . $equip;
                      echo '</td><td> ' . $row3['Total'] . ' ';


                      $query33 = sprintf("SELECT count(DISTINCT(equipo)) as totale FROM olimpiada24 where estado_olimpiada24=1 AND nombre_olimpiada24='$equip'");
                  ...
                  mysql_free_result($select3);
                  echo '</table>';
                  echo '<br><b>Total: ' . $todaolimpiada24 . '</b>';
